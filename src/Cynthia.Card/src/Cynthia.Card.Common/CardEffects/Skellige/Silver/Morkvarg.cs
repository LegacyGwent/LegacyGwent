...
namespace Cynthia.Card
{
    ...
    public class Morkvarg : CardEffect, IHandlesEvent<AfterCardToCemetery>, IHandlesEvent<AfterRoundOver>
    {//进入墓场时，复活自身，但战力削弱一半。
        ...
        public async Task HandleEvent(AfterRoundOver @event)
        {
            ...
            await Card.Effect.Weaken(WeakenValue, Card);
            //复活到原位置所在行的
            await Card.Effect.Resurrect(new CardLocation(Card.Status.CardRow, 0), Card);
            return;
