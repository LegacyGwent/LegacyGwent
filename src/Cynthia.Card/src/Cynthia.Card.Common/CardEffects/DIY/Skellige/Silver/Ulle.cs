...
namespace Cynthia.Card
{
    ...
    {//On turn start, if this card is in the graveyard, resurrect self. On turn end, duel the lowest enemy, if you win, lock self.
    // 回合开始时，复活自身到随机排，回合结束时，与最弱的敌方单位决斗，如果获胜，则锁定自身。
        ...
        // On turn end, duel the lowest enemy, if you win, lock self.
        {
