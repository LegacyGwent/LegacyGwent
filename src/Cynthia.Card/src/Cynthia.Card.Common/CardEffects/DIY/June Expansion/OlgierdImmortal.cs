...
{
    [CardEffectId("70082")]//莫克瓦格
    public class OlgierdImmortal : CardEffect, IHandlesEvent<AfterCardToCemetery>, IHandlesEvent<BeforeRoundStart>//, IHandlesEvent<AfterRoundOver>, IHandlesEvent<AfterTurnStart>
