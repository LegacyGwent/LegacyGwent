    ...
    { 
        ...
        { 
            ...
            { 
                ...
                new GwentCard() 
                { 
                    CardId ="43018", // Sabrina's Specter
                    Name="萨宾娜的幽灵", 
                    Strength=3, 
                    Group=Group.Silver, 
                    Faction = Faction.NorthernRealms, 
            ...
            { 
                ...
                new GwentCard() 
                { 
                    CardId ="64026", // Drummond Shieldmaid
                    Name="德拉蒙家族持盾女卫", 
                    Strength=3, 
                    Group=Group.Copper, 
                    Faction = Faction.Skellige, 
            ...
            { 
                ...
                new GwentCard() 
                { 
                    CardId = "70017", // Cintrian Field Medic
                    Name = "辛特拉战地医师", 
                    Strength = 5, 
                    Group = Group.Copper, 
                    Faction = Faction.NorthernRealms, 
            ...
            { 
                ...
                new GwentCard() 
                { 
                    CardId = "70040", // Dire Wolf Warrior
                    Name = "恐狼勇士", 
                    Strength = 10, 
                    Group = Group.Copper, 
                    Faction = Faction.Skellige, 
