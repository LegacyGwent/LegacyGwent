...
namespace Cynthia.Card
{
    public abstract class Player
    {
        ...
        public Task SendAsync(Operation<ServerOperationType> operation) =>
            _upstream.SendAsync(operation);

        public Task SendAsync(ServerOperationType type, params object[] data) =>
            _upstream.SendAsync(Operation.Create(type, data));
        ...
        {
            add => _upstream.Receive += value;
            remove => _upstream.Receive -= value;
        }
    }
}
