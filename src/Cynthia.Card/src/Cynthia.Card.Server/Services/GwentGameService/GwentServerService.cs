...
- 斯瓦勃洛牧师 10-呓语，受到己方伤害时，对1个敌军单位造成等额伤害。

Scoia'tael:
- 巨橡 13-树灵，择一，削弱一个敌军单位一半的基础战力；打出1张铜色树精牌，随后将其放回牌组。
- 树精的呵护 0-特殊、自然，打出1张银色/铜色树精牌，使其获得等同于场上友军树精单位数量的增益。
- 树人野猪 6-树灵，造成3点伤害，使目标相邻单位移至随机排，若摧毁目标单位则重复1次。
- 树精林卫 3-树精，使1个友军单位获得7点增益，己方打出战力低于自身的单位时，获得1点增益。

Northern Realm:
- 阿德莉亚女王 3-辛特拉，生成1张铜色辛特拉牌，若起始卡组中只有北方领域牌，则将自身放回牌组。
- 维赛基德 4-军官, 辛特拉，造成8点伤害，再造成等同于自身增益的伤害。
- 辛特拉老骑士 8-士兵, 辛特拉，己方打出辛特拉单位时，使自身与其获得1点增益。
- 辛特拉使者 3-辛特拉，打出1张自身的同名牌，若牌组没有同名牌则随机将一张铜色辛特拉牌加入牌组。

Monsters:
- 奥莉安娜 9-吸血鬼，选择1个敌军单位，使己方场上所有吸血鬼单位各汲取其1点战力
- 加尔 4-对两个敌军单位造成5点伤害
- 渴血鸟怪 3-吸血鬼，友军吸血鬼单位摧毁单位时召唤一个同名牌。友军非同名单位汲取时，汲取相同目标1点战力。
- 吸血鬼女 8-吸血鬼，回合结束时，若同排没有敌军单位则随机汲取1个敌军单位1点战力。

Nilfgaard:
- 安娜·亨利叶塔6-领袖、贵族，将牌组中的牌按基础战力从低到高排序，随后打出牌组顶端的一张牌。
- 文森特·凡·莫拉汉姆 7-吸血鬼，摧毁1个敌军单位，使其相邻单位各获得其战力一半的增益。
- 菲利普·凡·莫拉汉姆 8-吸血鬼，对一个敌军单位造成4点伤害，回合结束时若位于手牌则揭示自身并触发此能力
- 莫拉汉姆家斟酒侍者 9-吸血鬼，回合结束时，若对方场上没有金色单位则获得1点增益
- 莫拉汉姆家猎手 8-吸血鬼，对一个敌军单位造成3点伤害，若手牌中有金色谋略牌则使其获得佚亡

Neutral:
- 爱丽丝:庄园幽影 13-诅咒生物，休战，向双方手牌中添加两张爱丽丝的伙伴。
- 波维斯的科恩 7-对1个敌军单位造成3点伤害，直至其战力低于自身。
- 哈吉的伊斯贝尔 9-法师，重置1个单位，若为友军单位则重复1次。
- 穿甲弹 0-特殊、道具，对一个敌军单位造成8点伤害，若其具有增益则改为10点。
- 紫藤花 0-特殊、炼金选择2个单位，若为偶数使其获得6点增益，若为奇数对其造成6点伤害。

改动
重做性改动
- 恩约夫 9-摧毁双方场上所有战力低于3的单位
- 暴风雨 0-选择4排降下倾盆大雨，若其上有倾盆大雨则改为降下史凯利杰风暴。
- 克努特  4-打出牌组中基础战力最高的铜色士兵牌，对其与一个敌军单位造成等同其战力一半的伤害
- 图尔赛克家族战船 9-回合结束时，随机对1个未受伤的单位造成2点伤害。
- 防盾 10-右侧单位受到伤害时，优先抵扣自身的护甲。驱动：获得6点护甲
- 辛特拉皇家护卫 8-使自身获得4点增益，若己方落后则改为使相邻单位获得4点增益。
- 破坏者 1-随机打出1张铜色道具牌，使其造成的伤害提升1点
- 莫拉汉姆家仆从 8-免疫，被隐匿时获得6点增益。
...
还原性改动
- 亚尔潘·齐格林、马哈坎捍卫者、利维亚的杰洛特、暗影长者、暗算、迪门家族走私贩
