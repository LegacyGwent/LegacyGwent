Shader "DynamicCards/LatestVariant/ShaderLibrary_Generic_GwentStandard__800bf9a68c" {
Properties {
...
float4 dc_pack_OSGN_2=float4(0,0,0,0);
  ...
  r1.yw = r1.yw * dc_v_cb0[5].xy + dc_v_cb0[5].zw;
  r0.x = dc_v_cb1[0].x * dc_v_cb0[22].z + dc_v_cb4[0].x;
  r0.x = v4.z + r0.x;
  r0.x = v4.w + r0.x;
  dc_pack_OSGN_1.xy = dc_v_cb0[6].xy * r0.xx + r1.yw;
  dc_pack_OSGN_1.zw = dc_v_cb0[9].xy * r0.xx;
  r1.y = 1 + -dc_v_cb0[12].z;
  r1.xy = v4.xy * r1.yy + r1.xz;
  r1.xy = r1.xy * dc_v_cb0[11].xy + dc_v_cb0[11].zw;
  dc_pack_OSGN_2.xy = dc_v_cb0[12].xy * r0.xx + r1.xy;
