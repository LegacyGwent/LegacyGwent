Shader "DynamicCards/LatestVariant/ShaderLibrary_VFX_Generic_FourChanelSpriteAnim_AlphaBlend__d41d8cd98f" {
Properties {
...
dc_f_cb0[6]=float4(_OpacityMultiplier,0,0,0);
  ...
  r0.xzw = r0.xxx * r1.xyz + dc_f_cb0[3].xyz;
  r1.xyz = dc_f_cb0[5].zzz + r0.xzw;
  r1.xyz = r1.xyz * r0.yyy;
  o0.xyz = saturate(r1.xyz * dc_f_cb0[5].zzz + r0.xzw);
  return;
}
ENDCG
}
