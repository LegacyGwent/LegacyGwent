Shader "DynamicCards/LatestVariant/ShaderLibrary_Generic_GwentStandard__d83241658a" {
Properties {
...
float4 dc_pack_OSGN_2=float4(0,0,0,0);
  ...
  o6.xyz = r1.xyz;
  dc_pack_OSGN_2.xy = v4.xy * dc_v_cb0[11].xy + dc_v_cb0[11].zw;
  o3.xyz = float3(0,0,0);
  o4.xyz = float3(0,0,0);
  o5.xyzw = v3.xyzw;
