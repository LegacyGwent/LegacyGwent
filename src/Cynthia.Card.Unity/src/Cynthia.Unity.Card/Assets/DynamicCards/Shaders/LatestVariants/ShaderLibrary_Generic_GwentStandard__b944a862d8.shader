Shader "DynamicCards/LatestVariant/ShaderLibrary_Generic_GwentStandard__b944a862d8" {
Properties {
...
dc_v_cb0[21]=float4(0,0,0,_FramesNum);
dc_v_cb0[22]=float4(_FramesX,_FramesY,_TimeMultiplier,0);
...
float4 dc_pack_OSGN_1=float4(0,0,0,0);
  ...
  r0.x = v4.w + r0.x;
  r0.y = frac(r0.x);
  r0.y = dc_v_cb0[21].w * r0.y;
  r0.y = floor(r0.y);
  r0.z = 1 / dc_v_cb0[21].w;
  r0.w = dc_v_cb0[22].x + -r0.z;
  r0.z = r0.x + -r0.z;
  r0.x = dc_v_cb0[21].w * r0.x;
  o3.z = frac(r0.x);
  r0.x = frac(r0.z);
  r0.x = dc_v_cb0[21].w * r0.x;
  r0.x = floor(r0.x);
  r0.xz = max(float2(0,0), r0.xw);
  r0.x = min(dc_v_cb0[21].w, r0.x);
  r0.xy = dc_v_cb0[22].xx + r0.xy;
  r0.z = min(dc_v_cb0[22].x, r0.z);
  r0.w = r0.y / r0.z;
  r0.z = r0.x / r0.z;
  r0.zw = floor(r0.zw);
  r0.y = -dc_v_cb0[22].x * r0.w + r0.y;
  r0.w = v4.y + -r0.w;
  r0.y = v4.x + r0.y;
  dc_pack_OSGN_1.xy = r0.yw / dc_v_cb0[22].xy;
  dc_pack_OSGN_1.zw = v4.xy * dc_v_cb0[8].xy + dc_v_cb0[8].zw;
  o2.xy = v4.xy * dc_v_cb0[11].xy + dc_v_cb0[11].zw;
  r0.x = -dc_v_cb0[22].x * r0.z + r0.x;
  r0.y = v4.y + -r0.z;
  r0.x = v4.x + r0.x;
  o3.xy = r0.xy / dc_v_cb0[22].xy;
...
float4 dc_pack_ISGN_1=float4(v1.x,v1.y,w1.x,w1.y);
  ...
  r0.xyzw = _Mask.Sample(sampler_Mask, v4.xy).xyzw;
  r0.x = r0.x * r0.w;
  r0.y = dc_f_cb0[21].z + v4.z;
  r0.yz = dc_f_cb0[21].xy + r0.yy;
  r0.z = r0.z + -r0.y;
  r0.y = r0.y / r0.z;
  r0.z = 1 / r0.z;
  r0.x = saturate(r0.x * r0.z + -r0.y);
  r1.xyzw = _SecondTex.Sample(sampler_SecondTex, dc_pack_ISGN_1.zw).xyzw;
  r0.yzw = dc_f_cb0[10].xyz * r1.xyz;
  r1.xyzw = _ThirdTex.Sample(sampler_ThirdTex, v2.xy).xyzw;
  r1.xyz = dc_f_cb0[13].xyz * r1.xyz;
  r0.yzw = r1.xyz * r0.yzw;
  r1.xyzw = _MainTex.Sample(sampler_MainTex, dc_pack_ISGN_1.xy).xyzw;
  r2.xyzw = _MainTex.Sample(sampler_MainTex, v3.xy).xyzw;
  r1.xyzw = -r2.xyzw + r1.xyzw;
  r1.xyzw = v3.zzzz * r1.xyzw + r2.xyzw;
  r1.xyzw = dc_f_cb0[7].xyzw * r1.xyzw;
  r1.xyz = r0.yzw * dc_f_cb0[4].xxx + r1.xyz;
  r1.xyzw = v7.xyzw * r1.xyzw;
  r0.x = r1.w * r0.x;
  ...
  r0.x = saturate(dc_f_cb0[26].w + v7.w);
