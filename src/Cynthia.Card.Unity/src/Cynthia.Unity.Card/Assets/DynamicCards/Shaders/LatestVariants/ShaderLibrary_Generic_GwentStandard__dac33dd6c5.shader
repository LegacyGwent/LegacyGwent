Shader "DynamicCards/LatestVariant/ShaderLibrary_Generic_GwentStandard__dac33dd6c5" {
Properties {
...
float4 dc_pack_OSGN_1=float4(0,0,0,0);
  ...
  r1.x = 1 + -dc_v_cb0[9].z;
  r0.yw = v4.xy * r1.xx + r0.yw;
  dc_pack_OSGN_1.zw = r0.yw * dc_v_cb0[8].xy + dc_v_cb0[8].zw;
