Shader "DynamicCards/LatestVariant/ShaderLibrary_Generic_GwentStandard__f552db1847" {
Properties {
...
float4 dc_pack_ISGN_1=float4(v1.x,v1.y,w1.x,w1.y);
  ...
  r0.xyzw = dc_f_cb0[10].xyxy * r0.xyzw;
  r1.xyzw = _ThirdTex.Sample(sampler_ThirdTex, v2.xy).xyzw;
  r1.xyzw = dc_f_cb0[13].xyxy * r1.xyxy;
  r0.xyzw = r1.xyzw * r0.xyzw;
  r0.xyzw = r0.xyzw * dc_f_cb0[4].xxxx + dc_pack_ISGN_1.xyxy;
  r1.xy = r0.zw * dc_f_cb0[16].xy + dc_f_cb0[16].zw;
  ...
  r0.xyzw = r1.xyzw * v3.xxyy + r0.xyzw;
