Shader "DynamicCards/LatestVariant/ShaderLibrary_Generic_GwentStandard__b324f94443" {
Properties {
...
float4 dc_pack_ISGN_1=float4(v1.x,v1.y,w1.x,w1.y);
  ...
  r0.zw = dc_f_cb0[7].xw * r1.xw;
  r0.zw = v5.xw * r0.zw;
  r0.x = saturate(r0.w * r0.y + -r0.x);
  r0.x = r0.z * r0.x + dc_f_cb0[19].z;
