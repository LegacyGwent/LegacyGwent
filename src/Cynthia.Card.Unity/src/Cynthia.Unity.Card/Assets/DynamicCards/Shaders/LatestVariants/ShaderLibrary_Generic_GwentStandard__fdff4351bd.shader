Shader "DynamicCards/LatestVariant/ShaderLibrary_Generic_GwentStandard__fdff4351bd" {
Properties {
...
void dc_v(
  ...
  out float3 o8 : NORMAL0,
  out float4 o9 : TANGENT0)
{
float4 dc_v_cb4[1];
...
dc_v_cb2[7]=float4(unity_WorldToObject[0][3],unity_WorldToObject[1][3],unity_WorldToObject[2][3],unity_WorldToObject[3][3]);
dc_v_cb2[8]=float4(0,0,0,0);
dc_v_cb2[9]=float4(unity_WorldTransformParams.x,unity_WorldTransformParams.y,unity_WorldTransformParams.z,unity_WorldTransformParams.w);
float4 dc_v_cb1[8];
...
float4 dc_pack_OSGN_1=float4(0,0,0,0);
  ...
  dc_pack_OSGN_1.xy = r0.yw * dc_v_cb0[5].xy + dc_v_cb0[5].zw;
  dc_pack_OSGN_1.zw = float2(0,0);
  r0.y = 1 + -dc_v_cb0[12].z;
  r0.xy = v4.xy * r0.yy + r0.xz;
  o2.xy = r0.xy * dc_v_cb0[11].xy + dc_v_cb0[11].zw;
  ...
  r0.x = r0.y + r0.y;
  o3.z = abs(r0.x);
  o4.xy = v4.xy * dc_v_cb0[19].xy + dc_v_cb0[19].zw;
  o4.z = v5.z;
  o5.xyz = float3(0,0,0);
  o6.xyz = float3(0,0,0);
  o7.xyzw = v3.xyzw;
  ...
  r0.w = rsqrt(r0.w);
  o8.xyz = r0.xyz * r0.www;
  r0.xyz = dc_v_cb2[1].xyz * v2.yyy;
  r0.xyz = dc_v_cb2[0].xyz * v2.xxx + r0.xyz;
  r0.xyz = dc_v_cb2[2].xyz * v2.zzz + r0.xyz;
  r0.w = dot(r0.xyz, r0.xyz);
  r0.w = rsqrt(r0.w);
  o9.xyz = r0.xyz * r0.www;
  o9.w = dc_v_cb2[9].w * v2.w;
...
dc_f_cb0[2]=float4(_Cutoff,_Brightness,0,0);
...
dc_f_cb0[8]=float4(_SecondTex_ST.x,_SecondTex_ST.y,_SecondTex_ST.z,_SecondTex_ST.w);
...
float4 dc_pack_ISGN_1=float4(v1.x,v1.y,w1.x,w1.y);
  ...
  r0.xyz = v9.yzx * v8.zxy;
  r0.xyz = v8.yzx * v9.zxy + -r0.xyz;
  r0.xyz = v9.www * r0.xyz;
  r1.xyzw = _ThirdTex.Sample(sampler_ThirdTex, v2.xy).xyzw;
  r1.xy = r1.xy * float2(2,2) + float2(-1,-1);
  r1.xy = dc_f_cb0[13].xy * r1.xy;
  r0.xyz = r1.yyy * r0.xyz;
  r0.xyz = r1.xxx * v9.xyz + r0.xyz;
  r0.xyz = v8.xyz + r0.xyz;
  r0.z = dot(r0.xyz, r0.xyz);
  r0.z = rsqrt(r0.z);
  r0.xy = r0.xy * r0.zz;
  r0.xy = r0.xy * float2(0.5,0.5) + dc_f_cb0[8].zw;
  r0.xy = float2(0.5,0.5) + r0.xy;
  r0.xy = r0.xy * dc_f_cb0[8].xy + dc_pack_ISGN_1.zw;
  r0.xyzw = _SecondTex.Sample(sampler_SecondTex, r0.xy).xyzw;
  r0.xyz = dc_f_cb0[10].xyz * r0.xyz;
  r0.xyz = r0.xyz * r1.zzz;
  r0.xyz = dc_f_cb0[13].zzz * r0.xyz;
  r1.xy = dc_pack_ISGN_1.xy * dc_f_cb0[16].xy + dc_f_cb0[16].zw;
  r1.xyzw = _FlowTex.Sample(sampler_FlowTex, r1.xy).xyzw;
  r1.xyzw = float4(-0.00380000006,-0.00380000006,-0.00380000006,-0.00380000006) + r1.xyxy;
  r1.xyzw = r1.xyzw * float4(2,2,2,2) + float4(-1,-1,-1,-1);
  r1.xyzw = dc_f_cb0[18].yyyy * r1.xyzw;
  r1.xyzw = r1.xyzw * v3.xxyy + dc_pack_ISGN_1.xyxy;
  ...
  r1.xyz = r0.xyz * dc_f_cb0[4].xxx + r1.xyz;
  r0.xyzw = v7.xyzw * r1.xyzw;
  r1.xyzw = _Mask.Sample(sampler_Mask, v4.xy).xyzw;
  r1.x = r1.x * r1.w;
  r1.y = dc_f_cb0[21].z + v4.z;
  r1.yz = dc_f_cb0[21].xy + r1.yy;
  r1.z = r1.z + -r1.y;
  r1.y = r1.y / r1.z;
  r1.z = 1 / r1.z;
  ...
  r0.w = -dc_f_cb0[2].x + r0.w;
  r0.w = cmp(r0.w < 0);
  if (r0.w != 0) discard;
  r0.w = saturate(dc_f_cb0[26].w + v7.w);
