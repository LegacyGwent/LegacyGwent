Shader "DynamicCards/LatestVariant/ShaderLibrary_Generic_GwentStandard__6c60173ed6" {
Properties {
...
float4 dc_pack_OSGN_2=float4(0,0,0,0);
  ...
  r1.xy = v4.xy * r0.xx + r1.xz;
  dc_pack_OSGN_2.xy = r1.xy * dc_v_cb0[11].xy + dc_v_cb0[11].zw;
...
float4 dc_pack_ISGN_2=float4(v2.x,v2.y,w2,0);
  ...
  r1.xyzw = _ThirdTex.Sample(sampler_ThirdTex, dc_pack_ISGN_2.xy).xyzw;
