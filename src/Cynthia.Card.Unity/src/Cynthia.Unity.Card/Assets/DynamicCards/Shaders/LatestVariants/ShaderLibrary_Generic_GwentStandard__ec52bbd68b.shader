Shader "DynamicCards/LatestVariant/ShaderLibrary_Generic_GwentStandard__ec52bbd68b" {
Properties {
...
dc_v_cb0[9]=float4(_SecondTexUVAnim.x,_SecondTexUVAnim.y,0,0);
...
float4 dc_pack_OSGN_1=float4(0,0,0,0);
  ...
  dc_pack_OSGN_1.zw = dc_v_cb0[9].xy * r1.xx;
  r0.yw = dc_v_cb0[12].zz * r0.xz;
  r0.xz = dc_v_cb0[20].zz * r0.xz;
  r1.y = 1 + -dc_v_cb0[12].z;
  r0.yw = v4.xy * r1.yy + r0.yw;
  r0.yw = r0.yw * dc_v_cb0[11].xy + dc_v_cb0[11].zw;
  o2.xy = dc_v_cb0[12].xy * r1.xx + r0.yw;
  r0.y = 1 + -dc_v_cb0[20].z;
  r0.xy = v4.xy * r0.yy + r0.xz;
  r0.xy = r0.xy * dc_v_cb0[19].xy + dc_v_cb0[19].zw;
  o3.xy = dc_v_cb0[20].xy * r1.xx + r0.xy;
  o3.z = v5.z;
  o4.xyz = float3(0,0,0);
  o5.xyz = float3(0,0,0);
  o6.xyzw = v3.xyzw;
...
float4 dc_pack_ISGN_1=float4(v1.x,v1.y,w1.x,w1.y);
  ...
  r0.xyz = v8.yzx * v7.zxy;
  r0.xyz = v7.yzx * v8.zxy + -r0.xyz;
  r0.xyz = v8.www * r0.xyz;
  r1.xyzw = _ThirdTex.Sample(sampler_ThirdTex, v2.xy).xyzw;
  r1.xy = r1.xy * float2(2,2) + float2(-1,-1);
  r1.xy = dc_f_cb0[13].xy * r1.xy;
  r0.xyz = r1.yyy * r0.xyz;
  r0.xyz = r1.xxx * v8.xyz + r0.xyz;
  ...
  r0.xyzw = v6.xyzw * r1.xyzw;
  r1.xyzw = _Mask.Sample(sampler_Mask, v3.xy).xyzw;
  r1.x = r1.x * r1.w;
  r1.y = dc_f_cb0[21].z + v3.z;
