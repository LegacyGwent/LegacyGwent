Shader "DynamicCards/LatestVariant/ShaderLibrary_Generic_GwentStandard__aab1c7c5cd" {
Properties {
...
float4 dc_pack_OSGN_2=float4(0,0,0,0);
  ...
  r1.xyz = dc_v_cb2[3].xyz * v0.www + r1.xyz;
  r1.xyz = dc_v_cb1[4].xyz + -r1.xyz;
  r3.xyz = dc_v_cb3[18].xyw * r2.yyy;
  r3.xyz = dc_v_cb3[17].xyw * r2.xxx + r3.xyz;
  r2.xyz = dc_v_cb3[19].xyw * r2.zzz + r3.xyz;
  r2.xyz = dc_v_cb3[20].xyw * r2.www + r2.xyz;
  r2.w = dc_v_cb1[5].x * r2.y;
  r2.xy = r2.xw / r2.zz;
  r0.w = dc_v_cb1[6].y / dc_v_cb1[6].x;
  r2.z = r2.y * -r0.w;
  r2.yw = dc_v_cb0[9].zz * r2.xz;
  r0.w = 1 + -dc_v_cb0[9].z;
  r2.yw = v4.xy * r0.ww + r2.yw;
  r2.yw = r2.yw * dc_v_cb0[8].xy + dc_v_cb0[8].zw;
  r0.w = dc_v_cb1[0].x * dc_v_cb0[22].z + dc_v_cb4[0].x;
  r0.w = v4.z + r0.w;
  r0.w = v4.w + r0.w;
  r2.yw = dc_v_cb0[9].xy * r0.ww + r2.yw;
  r3.xyzw = _SecondTex.SampleLevel(sampler_SecondTex, r2.yw, 0).xyzw;
  dc_pack_OSGN_1.zw = r2.yw;
  r3.xyz = r3.xyz * float3(2,2,2) + float3(-1,-1,-1);
  r3.xyz = dc_v_cb0[10].xyz * r3.xyz;
  r4.xyz = v2.xyz * r3.yyy;
  r0.xyz = r0.xyz * r3.xxx + r4.xyz;
  r0.xyz = v1.xyz * r3.zzz + r0.xyz;
  r2.yw = dc_v_cb0[12].zz * r2.xz;
  r2.xz = dc_v_cb0[6].zz * r2.xz;
  r1.w = 1 + -dc_v_cb0[12].z;
  r2.yw = v4.xy * r1.ww + r2.yw;
  r2.yw = r2.yw * dc_v_cb0[11].xy + dc_v_cb0[11].zw;
  r2.yw = dc_v_cb0[12].xy * r0.ww + r2.yw;
  r3.xyzw = _ThirdTex.SampleLevel(sampler_ThirdTex, r2.yw, 0).xyzw;
  dc_pack_OSGN_2.xy = r2.yw;
  r3.xyz = dc_v_cb0[13].xyz * r3.xyz;
  r0.xyz = r3.xyz * r0.xyz;
  r0.xyz = r0.xyz * dc_v_cb0[4].xxx + v0.xyz;
  r3.xyzw = dc_v_cb2[1].xyzw * r0.yyyy;
  r3.xyzw = dc_v_cb2[0].xyzw * r0.xxxx + r3.xyzw;
  r3.xyzw = dc_v_cb2[2].xyzw * r0.zzzz + r3.xyzw;
  r3.xyzw = dc_v_cb2[3].xyzw + r3.xyzw;
  r4.xyzw = dc_v_cb3[18].xyzw * r3.yyyy;
  r4.xyzw = dc_v_cb3[17].xyzw * r3.xxxx + r4.xyzw;
  r4.xyzw = dc_v_cb3[19].xyzw * r3.zzzz + r4.xyzw;
  r3.xyzw = dc_v_cb3[20].xyzw * r3.wwww + r4.xyzw;
  r0.x = dc_v_cb0[28].x / dc_v_cb1[7].z;
  o0.z = r3.z + r0.x;
  o0.xyw = r3.xyw;
  r0.x = 1 + -dc_v_cb0[6].z;
  r0.xy = v4.xy * r0.xx + r2.xz;
  r0.xy = r0.xy * dc_v_cb0[5].xy + dc_v_cb0[5].zw;
  dc_pack_OSGN_1.xy = dc_v_cb0[6].xy * r0.ww + r0.xy;
  r0.x = dot(r1.xyz, r1.xyz);
  r0.x = rsqrt(r0.x);
  r0.xyz = r1.xyz * r0.xxx;
  r1.x = dot(v1.xyz, dc_v_cb2[4].xyz);
  r1.y = dot(v1.xyz, dc_v_cb2[5].xyz);
  r1.z = dot(v1.xyz, dc_v_cb2[6].xyz);
  r0.w = dot(r1.xyz, r1.xyz);
  r0.w = rsqrt(r0.w);
  r1.xyz = r1.xyz * r0.www;
  dc_pack_OSGN_2.z = dot(r1.xyz, r0.xyz);
  o3.xyz = float3(0,0,0);
  o4.xyz = float3(0,0,0);
  o5.xyzw = v3.xyzw;
  o6.xyz = float3(0,0,0);
...
float4 dc_pack_ISGN_2=float4(v2.x,v2.y,w2,0);
  ...
  o0.w = r1.x * r0.x;
  r0.x = saturate(dc_f_cb0[26].w + v5.w);
