Shader "DynamicCards/LatestVariant/ShaderLibrary_Generic_GwentStandard__f5485e9d57" {
Properties {
...
float4 dc_pack_ISGN_1=float4(v1.x,v1.y,w1.x,w1.y);
  ...
  r0.xyzw = _ThirdTex.Sample(sampler_ThirdTex, v2.xy).xyzw;
  r0.xy = dc_f_cb0[13].xw * r0.xw;
  r0.x = min(r0.x, r0.y);
  ...
  r0.yz = dc_f_cb0[7].xw * r2.xw;
  r1.xy = r1.xw * dc_f_cb0[10].xw + -r0.yz;
