Shader "DynamicCards/LatestVariant/ShaderLibrary_Generic_GwentStandard__9689df21d2" {
Properties {
...
float4 dc_pack_OSGN_1=float4(0,0,0,0);
  ...
  r1.xy = v4.xy * dc_v_cb0[8].xy + dc_v_cb0[8].zw;
  r2.xyzw = _SecondTex.SampleLevel(sampler_SecondTex, r1.xy, 0).xyzw;
  dc_pack_OSGN_1.zw = r1.xy;
  r1.xyz = r2.xyz * float3(2,2,2) + float3(-1,-1,-1);
  r1.xyz = dc_v_cb0[10].xyz * r1.xyz;
  r2.xyz = v2.xyz * r1.yyy;
  r0.xyz = r0.xyz * r1.xxx + r2.xyz;
  r0.xyz = v1.xyz * r1.zzz + r0.xyz;
  r1.xy = v4.xy * dc_v_cb0[11].xy + dc_v_cb0[11].zw;
  r2.xyzw = _ThirdTex.SampleLevel(sampler_ThirdTex, r1.xy, 0).xyzw;
  o2.xy = r1.xy;
  r1.xyz = dc_v_cb0[13].xyz * r2.xyz;
