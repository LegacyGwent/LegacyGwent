Shader "DynamicCards/LatestVariant/ShaderLibrary_Generic_GwentStandard__800d63a8f8" {
Properties {
...
dc_v_cb0[4]=float4(_Multiplier,0,0,0);
...
dc_v_cb0[10]=float4(_SecondTintColor.x,_SecondTintColor.y,_SecondTintColor.z,_SecondTintColor.w);
...
dc_v_cb0[13]=float4(_ThirdTintColor.x,_ThirdTintColor.y,_ThirdTintColor.z,_ThirdTintColor.w);
...
dc_v_cb0[19]=float4(_Mask_ST.x,_Mask_ST.y,_Mask_ST.z,_Mask_ST.w);
dc_v_cb0[20]=float4(_MaskUVAnim.x,_MaskUVAnim.y,_Mask_SSUV,0);
...
float4 dc_pack_OSGN_1=float4(0,0,0,0);
  ...
  r2.xyz = dc_v_cb3[18].xyw * r1.yyy;
  r2.xyz = dc_v_cb3[17].xyw * r1.xxx + r2.xyz;
  r1.xyz = dc_v_cb3[19].xyw * r1.zzz + r2.xyz;
  r1.xyz = dc_v_cb3[20].xyw * r1.www + r1.xyz;
  r1.w = dc_v_cb1[5].x * r1.y;
  r1.xy = r1.xw / r1.zz;
  r1.w = dc_v_cb1[6].y / dc_v_cb1[6].x;
  r1.z = r1.y * -r1.w;
  r1.yw = dc_v_cb0[9].zz * r1.xz;
  r1.yw = v4.xy * r0.ww + r1.yw;
  r1.yw = r1.yw * dc_v_cb0[8].xy + dc_v_cb0[8].zw;
  r0.w = dc_v_cb1[0].x * dc_v_cb0[22].z + dc_v_cb4[0].x;
  r0.w = v4.z + r0.w;
  r0.w = v4.w + r0.w;
  r1.yw = dc_v_cb0[9].xy * r0.ww + r1.yw;
  r2.xyzw = _SecondTex.SampleLevel(sampler_SecondTex, r1.yw, 0).xyzw;
  dc_pack_OSGN_1.zw = r1.yw;
  r2.xyz = r2.xyz * float3(2,2,2) + float3(-1,-1,-1);
  r2.xyz = dc_v_cb0[10].xyz * r2.xyz;
  r3.xyz = v2.xyz * r2.yyy;
  r0.xyz = r0.xyz * r2.xxx + r3.xyz;
  r0.xyz = v1.xyz * r2.zzz + r0.xyz;
  r1.yw = dc_v_cb0[12].zz * r1.xz;
  r2.x = 1 + -dc_v_cb0[12].z;
  r1.yw = v4.xy * r2.xx + r1.yw;
  r1.yw = r1.yw * dc_v_cb0[11].xy + dc_v_cb0[11].zw;
  r1.yw = dc_v_cb0[12].xy * r0.ww + r1.yw;
  r2.xyzw = _ThirdTex.SampleLevel(sampler_ThirdTex, r1.yw, 0).xyzw;
  o2.xy = r1.yw;
  r2.xyz = dc_v_cb0[13].xyz * r2.xyz;
  r0.xyz = r2.xyz * r0.xyz;
  r0.xyz = r0.xyz * dc_v_cb0[4].xxx + v0.xyz;
  r2.xyzw = dc_v_cb2[1].xyzw * r0.yyyy;
  r2.xyzw = dc_v_cb2[0].xyzw * r0.xxxx + r2.xyzw;
  r2.xyzw = dc_v_cb2[2].xyzw * r0.zzzz + r2.xyzw;
  r2.xyzw = dc_v_cb2[3].xyzw + r2.xyzw;
  r3.xyzw = dc_v_cb3[18].xyzw * r2.yyyy;
  r3.xyzw = dc_v_cb3[17].xyzw * r2.xxxx + r3.xyzw;
  r3.xyzw = dc_v_cb3[19].xyzw * r2.zzzz + r3.xyzw;
  r2.xyzw = dc_v_cb3[20].xyzw * r2.wwww + r3.xyzw;
  r0.x = dc_v_cb0[28].x / dc_v_cb1[7].z;
  o0.z = r2.z + r0.x;
  o0.xyw = r2.xyw;
  r0.xy = dc_v_cb0[6].zz * r1.xz;
  r1.xy = dc_v_cb0[20].zz * r1.xz;
  r0.z = 1 + -dc_v_cb0[6].z;
  r0.xy = v4.xy * r0.zz + r0.xy;
  r0.xy = r0.xy * dc_v_cb0[5].xy + dc_v_cb0[5].zw;
  dc_pack_OSGN_1.xy = dc_v_cb0[6].xy * r0.ww + r0.xy;
  r0.x = 1 + -dc_v_cb0[20].z;
  r0.xy = v4.xy * r0.xx + r1.xy;
  r0.xy = r0.xy * dc_v_cb0[19].xy + dc_v_cb0[19].zw;
  o3.xy = dc_v_cb0[20].xy * r0.ww + r0.xy;
  o3.z = v5.z;
  o4.xyz = float3(0,0,0);
  o5.xyz = float3(0,0,0);
  o6.xyzw = v3.xyzw;
...
dc_f_cb0[21]=float4(_MaskRemap.x,_MaskRemap.y,_MaskRemap.z,0);
...
float4 dc_pack_ISGN_1=float4(v1.x,v1.y,w1.x,w1.y);
  ...
  r0.xyzw = _Mask.Sample(sampler_Mask, v3.xy).xyzw;
  r0.x = r0.x * r0.w;
  r0.y = dc_f_cb0[21].z + v3.z;
  r0.yz = dc_f_cb0[21].xy + r0.yy;
  r0.z = r0.z + -r0.y;
  r0.y = r0.y / r0.z;
  r0.z = 1 / r0.z;
  ...
  r0.x = r1.w * r0.x;
  r0.yzw = dc_f_cb0[2].yyy * r1.xyz;
  r1.x = 1 + -dc_f_cb0[3].z;
  r1.xy = dc_f_cb0[3].xy + r1.xx;
  r1.y = r1.y + -r1.x;
  r1.x = r1.x / r1.y;
  r1.y = 1 / r1.y;
  o0.w = saturate(r0.x * r1.y + -r1.x);
  r0.x = saturate(dc_f_cb0[26].w + v6.w);
