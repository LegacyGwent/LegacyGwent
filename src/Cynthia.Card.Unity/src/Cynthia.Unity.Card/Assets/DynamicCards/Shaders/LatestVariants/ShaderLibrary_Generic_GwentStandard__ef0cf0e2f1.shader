Shader "DynamicCards/LatestVariant/ShaderLibrary_Generic_GwentStandard__ef0cf0e2f1" {
Properties {
...
float4 dc_pack_ISGN_1=float4(v1.x,v1.y,w1.x,w1.y);
  ...
  r1.xyz = dc_f_cb0[10].xyz * r1.xyz;
  r2.xyzw = _ThirdTex.Sample(sampler_ThirdTex, v2.xy).xyzw;
  r2.xyz = dc_f_cb0[13].xyz * r2.xyz;
  r1.xyz = r2.xyz * r1.xyz;
  r0.xyz = r1.xyz * dc_f_cb0[4].xxx + r0.xyz;
