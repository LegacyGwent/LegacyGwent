Shader "DynamicCards/LatestVariant/ShaderLibrary_Generic_GwentStandard__ccce292f76" {
Properties {
...
float4 dc_pack_ISGN_1=float4(v1.x,v1.y,w1.x,w1.y);
  ...
  r0.yz = dc_f_cb0[13].xw * r1.xw;
  r0.y = min(r0.y, r0.z);
  r1.xyzw = _SecondTex.Sample(sampler_SecondTex, dc_pack_ISGN_1.zw).xyzw;
  r2.xyzw = _MainTex.Sample(sampler_MainTex, dc_pack_ISGN_1.xy).xyzw;
  r2.xyzw = dc_f_cb0[7].xyzw * r2.xyzw;
  r1.xyzw = r1.xyzw * dc_f_cb0[10].xyzw + -r2.xyzw;
