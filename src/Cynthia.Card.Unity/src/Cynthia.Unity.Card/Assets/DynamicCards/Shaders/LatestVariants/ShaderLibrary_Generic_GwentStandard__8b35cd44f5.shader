Shader "DynamicCards/LatestVariant/ShaderLibrary_Generic_GwentStandard__8b35cd44f5" {
Properties {
...
float4 dc_pack_OSGN_2=float4(0,0,0,0);
  ...
  dc_pack_OSGN_1.zw = dc_v_cb0[9].xy * r0.xx + r1.yw;
  ...
  dc_pack_OSGN_2.z = dot(r2.xyz, r0.yzw);
  r0.y = 1 + -dc_v_cb0[12].z;
  r0.yz = v4.xy * r0.yy + r1.xz;
  r0.yz = r0.yz * dc_v_cb0[11].xy + dc_v_cb0[11].zw;
  dc_pack_OSGN_2.xy = dc_v_cb0[12].xy * r0.xx + r0.yz;
  o3.xyz = float3(0,0,0);
  o4.xyz = float3(0,0,0);
  o5.xyzw = v3.xyzw;
  o6.xyz = float3(0,0,0);
