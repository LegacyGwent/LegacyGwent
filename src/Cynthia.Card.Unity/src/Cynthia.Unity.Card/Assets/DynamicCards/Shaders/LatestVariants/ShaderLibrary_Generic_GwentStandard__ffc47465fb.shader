Shader "DynamicCards/LatestVariant/ShaderLibrary_Generic_GwentStandard__ffc47465fb" {
Properties {
...
dc_f_cb0[19]=float4(_Mask_ST.x,_Mask_ST.y,_Mask_ST.z,_Mask_ST.w);
...
float4 dc_pack_ISGN_1=float4(v1.x,v1.y,w1.x,w1.y);
  ...
  r0.x = dc_f_cb0[10].x * r0.x;
  r0.x = r0.x * r1.z;
  r0.x = dc_f_cb0[13].z * r0.x;
  r0.yz = dc_pack_ISGN_1.xy * dc_f_cb0[16].xy + dc_f_cb0[16].zw;
  r1.xyzw = _FlowTex.Sample(sampler_FlowTex, r0.yz).xyzw;
  ...
  r0.yz = r2.xw + -r1.xw;
  r0.yz = v3.zz * r0.yz + r1.xw;
  r1.yz = dc_f_cb0[7].xw * r0.yz;
  r1.x = r0.x * dc_f_cb0[4].x + r1.y;
  r0.xy = v6.xw * r1.xz;
  r0.z = 1 + -dc_f_cb0[3].z;
  r0.zw = dc_f_cb0[3].xy + r0.zz;
  r0.w = r0.w + -r0.z;
  r0.z = r0.z / r0.w;
  r0.w = 1 / r0.w;
  r0.y = saturate(r0.y * r0.w + -r0.z);
  r0.x = r0.x * r0.y + dc_f_cb0[19].z;
  r0.x = dc_f_cb0[19].x * r0.x;
  r0.y = 0.5;
