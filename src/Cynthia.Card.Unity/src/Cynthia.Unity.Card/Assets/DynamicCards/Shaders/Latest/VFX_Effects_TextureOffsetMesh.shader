Shader "DynamicCards/Latest/VFX_Effects_TextureOffsetMesh" {
Properties {
...
dc_f_cb0[3]=float4(_TimeMULT,0,0,0);
dc_f_cb0[4]=float4(_AlphaMask_ST.x,_AlphaMask_ST.y,_AlphaMask_ST.z,_AlphaMask_ST.w);
dc_f_cb0[5]=float4(_MainTex_ST.x,_MainTex_ST.y,_MainTex_ST.z,_MainTex_ST.w);
dc_f_cb0[6]=float4(_TimeMULT2,0,0,0);
  ...
  r0.xy = float2(0.800000012,1.39999998) * v1.xy;
  r0.zw = dc_f_cb1[0].yy * dc_f_cb0[3].xx + r0.xy;
  r0.xy = dc_f_cb1[0].yy * dc_f_cb0[6].xx + r0.xy;
  r0.xy = r0.xy * dc_f_cb0[5].xy + dc_f_cb0[5].zw;
  r1.xyzw = _MainTex.Sample(sampler_MainTex, r0.xy).xyzw;
  r0.xy = r0.zw * dc_f_cb0[5].xy + dc_f_cb0[5].zw;
