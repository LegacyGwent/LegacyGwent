Shader "DynamicCards/Latest/Shader_Forge_Additive_Mask_2UV_Sets" {
Properties {
_MainTex("_MainTex",2D)="white" {}
_TintColor("_TintColor",Color)=(0.5,0.5,0.5,1.0)
_TextureMask("_TextureMask",2D)="white" {}
}
SubShader {
...
dc_v_cb0[4]=float4(_TextureMask_ST.x,_TextureMask_ST.y,_TextureMask_ST.z,_TextureMask_ST.w);
...
float4 dc_pack_OSGN_1=float4(0,0,0,0);
  ...
  dc_pack_OSGN_1.xy = v1.xy * dc_v_cb0[2].xy + dc_v_cb0[2].zw;
...
float4 dc_pack_ISGN_1=float4(v1.x,v1.y,w1.x,w1.y);
  ...
  r0.xyzw = _TextureMask.Sample(sampler_TextureMask, dc_pack_ISGN_1.xy).xyzw;
