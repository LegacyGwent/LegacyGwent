Shader "DynamicCards/Latest/VFX_Special_ClearWeather_LightShaft" {
Properties {
...
_color_power("_color_power",Float)=1.0
}
SubShader {
...
dc_f_cb0[7]=float4(_node_8192,_color_power,0,0);
