Shader "DynamicCards/Latest/Custom_UI_Grayscale" {
Properties {
_MainTex("_MainTex",2D)="white" {}
_Color("_Color",Color)=(1.0,1.0,1.0,1.0)
_Grayscale("_Grayscale",Float)=0.0
...
dc_f_cb0[4]=float4(_Grayscale,0,0,0);
  ...
  r0.yzw = -r0.yzw * r0.xxx + r1.www;
  o0.w = r0.x;
  o0.xyz = dc_f_cb0[4].xxx * r0.yzw + r1.xyz;
  return;
}
ENDCG
}
