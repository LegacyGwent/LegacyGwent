Shader "DynamicCards/Latest/Skybox_Procedural" {
Properties {
_SunDisk("_SunDisk",Float)=2.0
_SunSize("_SunSize",Float)=0.03999999910593033
_SunSizeConvergence("_SunSizeConvergence",Float)=5.0
...
dc_v_cb0[6]=float4(_SkyTint.x,_SkyTint.y,_SkyTint.z,_AtmosphereThickness);
...
float4 dc_pack_OSGN_1=float4(0,0,0,0);
  ...
  dc_pack_OSGN_1.xyz = dc_v_cb0[4].xxx * r0.xyz;
...
float4 dc_pack_ISGN_1=float4(v1,w1.x,w1.y,w1.z);
  ...
  r0.yzw = -v2.xyz + dc_pack_ISGN_1.xyz;
