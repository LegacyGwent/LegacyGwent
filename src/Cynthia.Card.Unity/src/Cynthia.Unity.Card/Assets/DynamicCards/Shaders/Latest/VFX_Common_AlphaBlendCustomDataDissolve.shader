Shader "DynamicCards/Latest/VFX_Common_AlphaBlendCustomDataDissolve" {
Properties {
_MainTex("_MainTex",2D)="white" {}
_EmissionPower("_EmissionPower",Float)=2.0
...
dc_f_cb0[3]=float4(_EmissionPower,0,0,0);
