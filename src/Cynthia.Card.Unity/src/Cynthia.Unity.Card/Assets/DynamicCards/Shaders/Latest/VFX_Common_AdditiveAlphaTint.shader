Shader "DynamicCards/Latest/VFX_Common_AdditiveAlphaTint" {
Properties {
...
dc_f_cb0[4]=float4(_Brightness,_Miplevel,0,0);
  ...
  r0.xyzw = _MainTex.SampleLevel(sampler_MainTex, r0.xy, dc_f_cb0[4].y).xyzw;
  r0.xyzw = v2.wxyz * r0.wxyz;
  r0.yzw = dc_f_cb0[3].xyz * r0.yzw;
  r0.yzw = dc_f_cb0[4].xxx * r0.yzw;
  r0.yzw = dc_f_cb0[3].www * r0.yzw;
