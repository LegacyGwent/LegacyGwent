Shader "DynamicCards/Latest/VFX_VertexAnimation_ParticleVertAnimation" {
Properties {
...
_ScaleMulti("_ScaleMulti",Float)=1.0
...
dc_v_cb0[3]=float4(_AnimationLength,_MaxOffset,_ScaleMulti,_TimeScale);
  ...
  r1.xyzw = dc_v_cb2[3].xyzw * v0.wwww + r1.xyzw;
  r0.xyz = r1.xyz + r0.xyz;
  r2.xyzw = dc_v_cb3[18].xyzw * r0.yyyy;
  r2.xyzw = dc_v_cb3[17].xyzw * r0.xxxx + r2.xyzw;
  r0.xyzw = dc_v_cb3[19].xyzw * r0.zzzz + r2.xyzw;
  o1.xyzw = dc_v_cb3[20].xyzw * r1.wwww + r0.xyzw;
  return;
}
...
dc_f_cb0[4]=float4(_CutOff,0,0,0);
