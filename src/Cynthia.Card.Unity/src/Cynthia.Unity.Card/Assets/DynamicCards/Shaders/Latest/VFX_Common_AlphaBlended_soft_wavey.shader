Shader "DynamicCards/Latest/VFX_Common_AlphaBlended_soft_wavey" {
Properties {
...
dc_v_cb0[7]=float4(_VerticalHorizontal,0,0,_VColorOn);
  ...
  r0.y = min(1, abs(r0.y));
  r0.y = log2(r0.y);
  r0.y = dc_v_cb0[4].z * r0.y;
  r0.y = exp2(r0.y);
  r0.z = dc_v_cb1[0].y * dc_v_cb0[3].y;
  r0.x = r0.x * dc_v_cb0[3].w + r0.z;
  r0.zw = v1.xy * dc_v_cb0[6].xy + dc_v_cb0[6].zw;
  r1.xyzw = _Offsettexture.SampleLevel(sampler_Offsettexture, r0.zw, 0).xyzw;
  r0.x = r1.w * dc_v_cb0[4].w + r0.x;
  r0.z = -1 + r1.z;
  r0.z = dc_v_cb0[5].y * r0.z + 1;
  r0.x = sin(r0.x);
  r1.y = dc_v_cb0[3].z * r0.x;
  r1.xz = float2(0,0);
  r2.xyz = r1.yzz + -r1.zyz;
  r1.xyz = dc_v_cb0[7].xxx * r2.xyz + r1.xyz;
  r0.xyw = r1.xyz * r0.yyy;
  r1.xyz = r0.xyw * r0.zzz;
  r0.xyz = r0.xyw * v2.zzz + -r1.xyz;
  r0.xyz = dc_v_cb0[7].www * r0.xyz + r1.xyz;
...
dc_f_cb0[7]=float4(0,_Texturespeed,_TextureUV,0);
