Shader "DynamicCards/Latest/VFX_Effects_ImageLayerShaderFakeLightTop" {
Properties {
...
dc_f_cb0[7]=float4(_node_357.x,_node_357.y,_node_357.z,_node_357.w);
dc_f_cb0[8]=float4(_Vertex_Color,0,0,0);
  ...
  r0.x = 0.5 + dc_f_cb0[6].x;
  r0.x = dc_f_cb1[0].y * r0.x;
  r0.xy = r0.xx * dc_f_cb0[5].xy + dc_f_cb0[5].zw;
  r0.xyzw = _Turbulence.Sample(sampler_Turbulence, r0.xy).xyzw;
  r0.yz = v1.xy * dc_f_cb0[3].xy + dc_f_cb0[3].zw;
  r1.xyzw = _Light.Sample(sampler_Light, r0.yz).xyzw;
  r0.yzw = dc_f_cb0[4].xxx * r1.xyz;
  r1.xy = v1.xy * dc_f_cb0[2].xy + dc_f_cb0[2].zw;
  r1.xyzw = _MainTex.Sample(sampler_MainTex, r1.xy).xyzw;
  r0.xyz = r0.yzw * r0.xxx + r1.xyz;
  o0.w = r1.w;
  r1.xyz = dc_f_cb0[7].xyz * v2.xyz;
  r2.xyz = -v2.xyz * dc_f_cb0[7].xyz + dc_f_cb0[7].xyz;
  r1.xyz = dc_f_cb0[8].xxx * r2.xyz + r1.xyz;
