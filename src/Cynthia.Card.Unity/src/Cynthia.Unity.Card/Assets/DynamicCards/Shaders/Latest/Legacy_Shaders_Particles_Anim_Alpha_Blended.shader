Shader "DynamicCards/Latest/Legacy_Shaders_Particles_Anim_Alpha_Blended" {
Properties {
...
dc_v_cb0[2]=float4(_TintColor.x,_TintColor.y,_TintColor.z,_TintColor.w);
...
float4 dc_pack_OSGN_2=float4(0,0,0,0);
  ...
  dc_pack_OSGN_2.xyzw = v2.xyzw * dc_v_cb0[3].xyxy + dc_v_cb0[3].zwzw;
  o3.x = v3.x;
