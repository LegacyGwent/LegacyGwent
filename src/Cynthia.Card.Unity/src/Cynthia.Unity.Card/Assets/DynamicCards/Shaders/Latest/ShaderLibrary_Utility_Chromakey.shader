Shader "DynamicCards/Latest/ShaderLibrary_Utility_Chromakey" {
Properties {
_MainTex("_MainTex",2D)="white" {}
_Color("_Color",Color)=(1.0,1.0,1.0,1.0)
_Treshold("_Treshold",Float)=0.10000000149011612
...
dc_f_cb0[6]=float4(_Treshold,0,0,0);
  ...
  r1.y = r0.x + r0.z;
  r1.x = r1.y + r1.x;
  r1.x = cmp(abs(r1.x) >= dc_f_cb0[6].x);
