Shader "DynamicCards/Latest/Custom_Cards_CardCore_ImageLayerShaderMaskedGlow" {
Properties {
...
float4 dc_pack_ISGN_1=float4(v1.x,v1.y,w1.x,w1.y);
  ...
  r3.xyzw = dc_pack_ISGN_1.xyzw + -r3.yzyw;
