Shader "DynamicCards/Latest/Custom_morkvarg_dust" {
Properties {
_texture("_texture",2D)="white" {}
_brightness("_brightness",Float)=1.0
_distance_blend("_distance_blend",Float)=122.0
_fallof("_fallof",Float)=2.0
}
SubShader {
...
dc_f_cb0[3]=float4(_brightness,_distance_blend,_fallof,0);
  ...
  r0.x = sqrt(r0.x);
  r0.x = r0.x / dc_f_cb0[3].y;
  r0.x = log2(r0.x);
  r0.x = dc_f_cb0[3].z * r0.x;
  r0.x = exp2(r0.x);
  r0.x = min(1, r0.x);
  r0.yz = v1.xy * dc_f_cb0[2].xy + dc_f_cb0[2].zw;
  r1.xyzw = _texture.Sample(sampler_texture, r0.yz).xyzw;
  r0.y = r1.x + -r1.y;
  r0.x = r0.x * r0.y + r1.y;
  r0.xyz = v3.xyz * r0.xxx;
  r0.xyz = v3.www * r0.xyz;
  o0.xyz = dc_f_cb0[3].xxx * r0.xyz;
  o0.w = 1;
  return;
}
ENDCG
