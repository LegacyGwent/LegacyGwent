Shader "DynamicCards/Latest/Hidden_ShaderLibrary_Utility_SnapShooterWatermark" {
Properties {
...
dc_f_cb0[6]=float4(_ScreenParams.x,_ScreenParams.y,_ScreenParams.z,_ScreenParams.w);
