Shader "DynamicCards/Latest/ShaderLibrary_UI_Specific_BasicGreyscale" {
Properties {
_MainTex("_MainTex",2D)="white" {}
_Color("_Color",Color)=(1.0,1.0,1.0,1.0)
_Greyscale("_Greyscale",Float)=0.0
...
dc_v_cb0[4]=float4(_MainTex_ST.x,_MainTex_ST.y,_MainTex_ST.z,_MainTex_ST.w);
  ...
  o2.xy = v2.xy * dc_v_cb0[4].xy + dc_v_cb0[4].zw;
  o3.xyzw = v0.xyzw;
  return;
}
...
dc_f_cb0[6]=float4(_Greyscale,0,0,0);
  ...
  o0.xyz = dc_f_cb0[6].xxx * r0.xyz + r1.xyz;
  o0.w = r1.w;
  return;
}
ENDCG
