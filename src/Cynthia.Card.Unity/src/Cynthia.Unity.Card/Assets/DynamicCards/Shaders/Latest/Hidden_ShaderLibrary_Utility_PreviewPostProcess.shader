Shader "DynamicCards/Latest/Hidden_ShaderLibrary_Utility_PreviewPostProcess" {
Properties {
  ...
  out float4 o0 : SV_Target0)
{
  ...
  o0.x = dot(float2(0.566670001,0.433329999), r0.xy);
  o0.y = dot(float2(0.558329999,0.441670001), r0.xy);
  o0.z = dot(float2(0.241669998,0.758329988), r0.yz);
  o0.w = r0.w;
  return;
}
ENDCG
