Shader "DynamicCards/Latest/VFX_Effects_ImageLayerShaderFakeLightScreen" {
Properties {
...
dc_f_cb0[7]=float4(_TintColor.x,_TintColor.y,_TintColor.z,_TintColor.w);
  ...
  r2.xyzw = _Light.Sample(sampler_Light, r0.yz).xyzw;
  r0.yzw = dc_f_cb0[4].xxx * r2.xyz;
  r0.xyz = r0.yzw * r0.xxx + r1.xyz;
  r0.xyz = dc_f_cb0[7].xyz * r0.xyz;
  r0.xyz = dc_f_cb0[7].www * r0.xyz;
