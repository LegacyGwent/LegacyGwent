Shader "DynamicCards/Latest/Custom_Cards_Shop_ScorchCard_TransparentOverlay" {
Properties {
...
dc_v_cb0[2]=float4(_Noise_ST.x,_Noise_ST.y,_Noise_ST.z,_Noise_ST.w);
  ...
  o1.xy = v3.xy * dc_v_cb0[2].xy + dc_v_cb0[2].zw;
  o2.xyzw = v1.xyzw;
  return;
}
...
dc_f_cb0[3]=float4(_CutOff,0,0,0);
dc_f_cb0[4]=float4(_TintColor.x,_TintColor.y,_TintColor.z,_TintColor.w);
dc_f_cb0[5]=float4(_HeatColor.x,_HeatColor.y,_HeatColor.z,_HeatColor.w);
  ...
  r0.xyzw = _Noise.Sample(sampler_Noise, v1.xy).xyzw;
  r0.x = dc_f_cb0[3].x + r0.x;
  r0.x = log2(r0.x);
  r0.xy = float2(12,10) * r0.xx;
  r0.xy = exp2(r0.xy);
  r0.y = saturate(-0.600000024 + r0.y);
  r0.x = min(1, r0.x);
  r0.y = r0.y * r0.y;
  r0.y = r0.y * r0.y;
  r1.xyzw = r0.yyyy * -dc_f_cb0[5].xyzw + dc_f_cb0[5].xyzw;
  r1.xyzw = -dc_f_cb0[4].xyzw + r1.xyzw;
  r0.y = r0.x * r0.x;
  r0.y = r0.y * r0.y;
  r1.xyzw = r0.yyyy * r1.xyzw + dc_f_cb0[4].xyzw;
  r0.xyzw = r1.xyzw * r0.xxxx;
  r1.x = saturate(32 * dc_f_cb0[3].x);
