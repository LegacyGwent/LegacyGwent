Shader "DynamicCards/Latest/Custom_Particle_AlphaBlendedCC" {
Properties {
...
dc_f_cb0[4]=float4(_maxParticleAlpha,0,0,0);
  ...
  o0.xyz = saturate(r0.xyz + r0.xyz);
  o0.w = saturate(dc_f_cb0[4].x * r0.w);
  return;
}
ENDCG
}
