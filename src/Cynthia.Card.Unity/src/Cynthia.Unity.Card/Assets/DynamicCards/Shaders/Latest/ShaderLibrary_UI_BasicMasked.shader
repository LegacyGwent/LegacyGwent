Shader "DynamicCards/Latest/ShaderLibrary_UI_BasicMasked" {
Properties {
...
float4 dc_pack_ISGN_2=float4(v2.x,v2.y,w2.x,w2.y);
  ...
  r0.xyzw = _Mask.Sample(sampler_Mask, dc_pack_ISGN_2.xy).xyzw;
  r0.x = r0.x * r0.w;
  r1.xyzw = _MainTex.Sample(sampler_MainTex, dc_pack_ISGN_2.xy).xyzw;
  r1.xyzw = dc_f_cb0[3].xyzw + r1.xyzw;
