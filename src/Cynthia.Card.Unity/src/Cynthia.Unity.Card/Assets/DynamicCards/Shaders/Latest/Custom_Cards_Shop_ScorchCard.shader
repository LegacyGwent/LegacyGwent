Shader "DynamicCards/Latest/Custom_Cards_Shop_ScorchCard" {
Properties {
...
float4 dc_pack_OSGN_1=float4(0,0,0,0);
  ...
  dc_pack_OSGN_1.xy = v2.xy * dc_v_cb0[3].xy + dc_v_cb0[3].zw;
...
float4 dc_pack_ISGN_1=float4(v1.x,v1.y,w1.x,w1.y);
  ...
  r1.xyzw = _Noise.Sample(sampler_Noise, dc_pack_ISGN_1.xy).xyzw;
