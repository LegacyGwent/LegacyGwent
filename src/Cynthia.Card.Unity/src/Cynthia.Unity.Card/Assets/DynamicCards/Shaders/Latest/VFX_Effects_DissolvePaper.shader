Shader "DynamicCards/Latest/VFX_Effects_DissolvePaper" {
Properties {
...
_DissolveOffset("_DissolveOffset",Float)=0.0
...
dc_f_cb0[16]=float4(_minRemap,_maxRemap,_DissolveProgress,_DissolveOffset);
dc_f_cb0[17]=float4(_Cutoff,0,0,0);
  ...
  r0.z = r1.w * r0.x;
  r0.w = r0.z * dc_f_cb0[12].w + -dc_f_cb0[17].x;
  r0.z = log2(r0.z);
  r0.w = cmp(r0.w < 0);
  if (r0.w != 0) discard;
  ...
  r1.x = dc_f_cb0[16].w + -r1.x;
  r2.z = 1 + r1.x;
  r1.xy = r2.zw * dc_f_cb0[4].xy + dc_f_cb0[4].zw;
  r1.xyzw = _DissolveColorRamp.Sample(sampler_DissolveColorRamp, r1.xy).xyzw;
  r1.xyz = dc_f_cb0[5].xxx * r1.xyz;
  o0.xyz = saturate(r0.yzw * r0.xxx + r1.xyz);
  o0.w = 1;
  return;
}
ENDCG
