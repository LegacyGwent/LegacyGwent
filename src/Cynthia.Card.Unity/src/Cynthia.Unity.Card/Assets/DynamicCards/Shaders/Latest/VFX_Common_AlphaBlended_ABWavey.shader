Shader "DynamicCards/Latest/VFX_Common_AlphaBlended_ABWavey" {
Properties {
...
dc_v_cb0[5]=float4(_Usetextureoffset,0,0,0);
dc_v_cb0[6]=float4(_Offsettexture_ST.x,_Offsettexture_ST.y,_Offsettexture_ST.z,_Offsettexture_ST.w);
dc_v_cb0[7]=float4(_VerticalHorizontal,_Texturetimeoffset,0,0);
...
dc_f_cb0[7]=float4(0,0,_MainTexOpacity,0);
