Shader "DynamicCards/Latest/VFX_Common_AlphaBlended_moveInDirection_VertexColor_UVNoise" {
Properties {
...
dc_f_cb0[7]=float4(_AlphaPower,_ColorGain,_NoiseMultOverLifetime,0);
  ...
  r0.xy = dc_f_cb1[0].yy * dc_f_cb0[6].xy + v1.xy;
  r0.xy = v1.ww + r0.xy;
  r0.xy = r0.xy * dc_f_cb0[5].xy + dc_f_cb0[5].zw;
  r0.xyzw = _NoiseTex.Sample(sampler_NoiseTex, r0.xy).xyzw;
  r0.xy = float2(-0.5,-0.5) + r0.xy;
  r0.z = dc_f_cb0[6].z * v1.z + -dc_f_cb0[6].z;
  r0.z = dc_f_cb0[7].z * r0.z + dc_f_cb0[6].z;
  ...
  o0.xyz = dc_f_cb0[7].yyy * r0.xyz;
  r0.x = max(0.5, dc_f_cb0[7].x);
  r0.x = min(100, r0.x);
  r0.x = r0.x * r0.w;
  r0.x = exp2(r0.x);
  r0.x = dc_f_cb0[3].w * r0.x;
  r0.x = v2.w * r0.x;
