Shader "DynamicCards/Native/VFX_Effects_FlowingFlowmapZbuffer" {
Properties {
...
dc_f_cb0[7]=float4(_Secondaryamount,_Secondaryspeed,_Rotatespeed,_Cutoff);
  ...
  r0.x = cmp(dc_f_cb0[7].w >= r0.w);
  if (r0.x != 0) discard;
  r0.x = dc_f_cb1[0].y + dc_f_cb0[2].y;
  r0.yz = dc_f_cb0[7].zy * r0.xx;
  sincos(r0.y, r1.x, r2.x);
  r0.yw = float2(-0.5,-0.5) + v1.xy;
  r3.x = -r1.x;
  r3.y = r2.x;
  r3.z = r1.x;
  r1.x = dot(r0.yw, r3.yz);
  r1.y = dot(r0.yw, r3.xy);
  r0.yw = float2(0.5,0.5) + r1.xy;
  r0.yw = r0.yw * dc_f_cb0[5].xy + dc_f_cb0[5].zw;
  r1.xyzw = _Secondaryflowmap.Sample(sampler_Secondaryflowmap, r0.yw).xyzw;
  r0.yw = r1.xy * float2(2,2) + float2(-1,-1);
  r0.yw = dc_f_cb0[7].xx * r0.yw;
  r0.z = frac(r0.z);
  r1.xy = r0.yw * r0.zz + v1.xy;
  r1.xy = r1.xy * dc_f_cb0[6].xy + dc_f_cb0[6].zw;
  r1.xyzw = _FlowMap.Sample(sampler_FlowMap, r1.xy).xyzw;
  r1.z = dc_f_cb0[7].y * r0.x + 0.5;
  r1.z = frac(r1.z);
  r0.yw = r0.yw * r1.zz + v1.xy;
  r0.yw = r0.yw * dc_f_cb0[6].xy + dc_f_cb0[6].zw;
  r2.xyzw = _FlowMap.Sample(sampler_FlowMap, r0.yw).xyzw;
  r0.y = -0.5 + r0.z;
  r0.y = r0.y + r0.y;
  r0.zw = r2.xy + -r1.xy;
  r0.yz = abs(r0.yy) * r0.zw + r1.xy;
  r0.yz = r0.yz * float2(2,2) + float2(-1,-1);
  r0.yzw = dc_f_cb0[4].xxy * r0.yzx;
  r0.w = frac(r0.w);
  r1.xy = r0.yz * r0.ww + v1.xy;
  r1.xy = r1.xy * dc_f_cb0[3].xy + dc_f_cb0[3].zw;
  r1.xyzw = _MainTex.Sample(sampler_MainTex, r1.xy).xyzw;
  r0.x = r0.x * dc_f_cb0[4].y + 0.5;
  r0.x = frac(r0.x);
