Shader "DynamicCards/Native/VFX_Common_AlphaBlended_wavey_TwoWaves" {
Properties {
...
dc_v_cb0[7]=float4(_VerticalHorizontal,_VColourOn,_Texturetimeoffset,_Wavelength2);
dc_v_cb0[8]=float4(_UseUorV2,_UVmidpoint2,_Timeoffset2,_Offsetamount2);
dc_v_cb0[9]=float4(_Timemultiplier2,_VerticalHorizontal2,0,0);
  ...
  r0.x = v1.y + -v1.x;
  r0.y = dc_v_cb0[8].x * r0.x + v1.x;
  r0.x = dc_v_cb0[3].x * r0.x + v1.x;
  r0.x = -dc_v_cb0[4].x + r0.x;
  r0.y = -dc_v_cb0[8].y + r0.y;
  r0.y = dc_v_cb0[7].w * r0.y;
  r0.y = dc_v_cb1[0].y * dc_v_cb0[9].x + r0.y;
  r0.y = dc_v_cb0[8].z + r0.y;
  r0.y = cos(r0.y);
  r0.z = dc_v_cb1[0].y * dc_v_cb0[3].y;
  r0.z = r0.x * dc_v_cb0[3].w + r0.z;
  r0.z = dc_v_cb0[4].w + r0.z;
  r0.z = v2.w * dc_v_cb0[7].z + r0.z;
  r0.z = sin(r0.z);
  r1.y = dc_v_cb0[3].z * r0.z;
  r1.w = r0.y * dc_v_cb0[8].w + r1.y;
  r1.xz = float2(0,0);
  r0.yzw = r1.wzz + -r1.zwz;
  r0.yzw = dc_v_cb0[9].yyy * r0.yzw + r1.zwz;
  r2.xyz = r1.yzz + -r1.xyx;
  r1.xyz = dc_v_cb0[7].xxx * r2.xyz + r1.zyz;
