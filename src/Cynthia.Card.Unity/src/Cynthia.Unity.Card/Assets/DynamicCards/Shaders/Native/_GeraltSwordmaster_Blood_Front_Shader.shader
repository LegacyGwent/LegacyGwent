Shader "DynamicCards/Native/_GeraltSwordmaster_Blood_Front_Shader" {
Properties {
...
dc_f_cb0[2]=float4(_node_1759_ST.x,_node_1759_ST.y,_node_1759_ST.z,_node_1759_ST.w);
dc_f_cb0[3]=float4(_Displace_Textre_ST.x,_Displace_Textre_ST.y,_Displace_Textre_ST.z,_Displace_Textre_ST.w);
dc_f_cb0[4]=float4(_displace_STR,_Displace_Time_Mult,0,0);
dc_f_cb0[5]=float4(_node_7946_ST.x,_node_7946_ST.y,_node_7946_ST.z,_node_7946_ST.w);
dc_f_cb0[6]=float4(_UV_Time_Mult_copy,0,0,0);
dc_f_cb0[7]=float4(_Detail_Texture_ST.x,_Detail_Texture_ST.y,_Detail_Texture_ST.z,_Detail_Texture_ST.w);
dc_f_cb0[8]=float4(_Color_7946.x,_Color_7946.y,_Color_7946.z,_Color_7946.w);
dc_f_cb0[9]=float4(_Mask_ST.x,_Mask_ST.y,_Mask_ST.z,_Mask_ST.w);
dc_f_cb0[10]=float4(_Color_1759.x,_Color_1759.y,_Color_1759.z,_Color_1759.w);
dc_f_cb0[11]=float4(_MaskRotation,_Mask_contrast,0,0);
dc_f_cb0[12]=float4(_Detail_color.x,_Detail_color.y,_Detail_color.z,_Detail_color.w);
dc_f_cb0[13]=float4(_OVERALL_OPACITY,0,0,0);
  ...
  r0.x = 0.0174532924 * dc_f_cb0[11].x;
  ...
  r0.x = log2(r0.x);
  r0.x = dc_f_cb0[11].y * r0.x;
  r0.x = exp2(r0.x);
  r0.y = dc_f_cb1[0].y * dc_f_cb0[4].y;
  r1.x = r0.y * 0.5 + v2.y;
  r1.y = dc_f_cb1[0].y * dc_f_cb0[4].y + v2.x;
  ...
  r1.xz = dc_f_cb0[4].xx * r0.yz;
  r1.y = v1.y;
  r0.yz = v1.xy + r1.xy;
  r1.x = dc_f_cb0[6].x * dc_f_cb1[0].x + v1.x;
  r0.yz = r1.xz + r0.yz;
  r0.yz = r0.yz * dc_f_cb0[2].xy + dc_f_cb0[2].zw;
  r2.xyzw = _node_1759.Sample(sampler_node_1759, r0.yz).xyzw;
  r1.y = v1.y;
  r0.yz = r1.xy * dc_f_cb0[5].xy + dc_f_cb0[5].zw;
  r1.xyzw = _node_7946.Sample(sampler_node_7946, r0.yz).xyzw;
  r0.y = r1.w + r2.w;
  r2.xyz = dc_f_cb0[10].xyz + r2.xyz;
  r1.xyz = dc_f_cb0[8].xyz + r1.xyz;
  r0.x = r0.y * r0.x;
  o0.w = dc_f_cb0[13].x * r0.x;
  r0.x = dc_f_cb1[0].x * dc_f_cb0[6].x;
  r0.x = r0.x * 0.25 + v1.x;
  r0.y = v1.y;
  r0.xy = r0.xy * dc_f_cb0[7].xy + dc_f_cb0[7].zw;
  r0.xyzw = _Detail_Texture.Sample(sampler_Detail_Texture, r0.xy).xyzw;
