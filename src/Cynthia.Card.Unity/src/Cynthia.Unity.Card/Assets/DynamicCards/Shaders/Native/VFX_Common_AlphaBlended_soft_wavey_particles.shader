Shader "DynamicCards/Native/VFX_Common_AlphaBlended_soft_wavey_particles" {
Properties {
...
_Texturespeed("_Texturespeed",Float)=0.0
_TextureUV("_TextureUV",Float)=0.0
_OpacityMask("_OpacityMask",2D)="white" {}
...
dc_v_cb0[8]=float4(_VerticalHorizontal,0,0,0);
...
dc_f_cb0[8]=float4(0,_Texturespeed,_TextureUV,0);
dc_f_cb0[9]=float4(_OpacityMask_ST.x,_OpacityMask_ST.y,_OpacityMask_ST.z,_OpacityMask_ST.w);
dc_f_cb0[10]=float4(_Tint.x,_Tint.y,_Tint.z,_Tint.w);
  ...
  r0.y = 0;
  r0.zw = r0.yx + -r0.xy;
  r0.xy = dc_f_cb0[8].zz * r0.zw + r0.xy;
  r0.xy = v1.xy + r0.xy;
  ...
  r1.xyzw = _OpacityMask.Sample(sampler_OpacityMask, r1.xy).xyzw;
  r0.w = r1.x * r0.w;
  r0.xyz = v2.xyz * r0.xyz;
  o0.xyz = dc_f_cb0[10].xyz * r0.xyz;
  o0.w = dc_f_cb0[10].w * r0.w;
  return;
}
ENDCG
}
