Shader "DynamicCards/Native/VFX_Special_Water_move" {
Properties {
...
dc_f_cb0[2]=float4(_OpacityNoise_ST.x,_OpacityNoise_ST.y,_OpacityNoise_ST.z,_OpacityNoise_ST.w);
dc_f_cb0[3]=float4(_TimeSpeed,_Noise_contrast,_Noise_Brightnes,0);
dc_f_cb0[4]=float4(_MainText_ST.x,_MainText_ST.y,_MainText_ST.z,_MainText_ST.w);
dc_f_cb0[5]=float4(_TintColor_01.x,_TintColor_01.y,_TintColor_01.z,_TintColor_01.w);
dc_f_cb0[6]=float4(_GradientBlur,_GradientSize,_OpacityBlur,_OpacityPower);
dc_f_cb0[7]=float4(_FloatMask_ST.x,_FloatMask_ST.y,_FloatMask_ST.z,_FloatMask_ST.w);
dc_f_cb0[8]=float4(_MaskBrightness,_MaskContrast,_Brightnes,_Contrast);
dc_f_cb0[9]=float4(_SpecularPlacement,_SpecularSize,0,0);
dc_f_cb0[10]=float4(_SpecularColour.x,_SpecularColour.y,_SpecularColour.z,_SpecularColour.w);
dc_f_cb0[11]=float4(_camrot,_camrot_offset,_camrot2,_SpecularBrightessosso);
dc_f_cb0[12]=float4(_reflectionsmgf,_RadialLinear,0,0);
dc_f_cb0[13]=float4(_Tint2.x,_Tint2.y,_Tint2.z,_Tint2.w);
  ...
  r0.z = v1.y;
  r0.xy = -dc_f_cb1[0].xx * dc_f_cb0[3].xx + v1.xy;
  r0.xz = r0.xz * dc_f_cb0[4].xy + dc_f_cb0[4].zw;
  r1.w = 0.236540005 + r0.y;
  r0.xyzw = _MainText.Sample(sampler_MainText, r0.xz).xyzw;
  r2.xy = dc_f_cb1[0].xx * dc_f_cb0[3].xx + v1.xy;
  r1.x = 0.236540005 + r2.x;
  r1.yz = v1.yx;
  r0.yz = r1.xy * dc_f_cb0[4].xy + dc_f_cb0[4].zw;
  r1.xy = r1.zw * dc_f_cb0[4].xy + dc_f_cb0[4].zw;
  r1.xyzw = _MainText.Sample(sampler_MainText, r1.xy).xyzw;
  r3.xyzw = _MainText.Sample(sampler_MainText, r0.yz).xyzw;
  r0.x = r3.x * r0.x;
  r2.z = v1.x;
  r0.yz = r2.zy * dc_f_cb0[4].xy + dc_f_cb0[4].zw;
  r2.xyzw = _MainText.Sample(sampler_MainText, r0.yz).xyzw;
  r0.x = r2.x * r0.x;
  r0.x = r0.x * r1.x;
  r0.y = 0.100000001 * dc_f_cb0[3].z;
  r0.x = saturate(r0.x * dc_f_cb0[3].y + r0.y);
  r0.y = r0.x * 2 + -1;
  r0.y = dc_f_cb0[12].x * r0.y;
  r0.zw = v2.xy / v2.ww;
  r0.zw = r0.zw * float2(2,2) + float2(-1,-1);
  r1.x = dot(r0.zw, r0.zw);
  r1.x = sqrt(r1.x);
  r1.x = 1 + -r1.x;
  r1.xy = dc_f_cb0[11].zx * r1.xx;
  r0.zw = r1.xy * float2(-0.00999999978,0.00999999978) + r0.zw;
  ...
  r0.xyz = r0.xyz * dc_f_cb0[8].www + dc_f_cb0[8].zzz;
  r0.xyz = saturate(dc_f_cb0[5].xyz * r0.xyz);
  ...
  r1.x = 1 + -r1.x;
  r1.x = -v1.y + r1.x;
  r1.x = dc_f_cb0[12].y * r1.x + v1.y;
  r1.x = r1.x * dc_f_cb0[6].x + dc_f_cb0[6].y;
  r1.y = dc_f_cb0[11].x * dc_f_cb0[11].y + dc_f_cb0[9].x;
  r1.y = r1.x + -r1.y;
  r1.zw = v1.xy * dc_f_cb0[7].xy + dc_f_cb0[7].zw;
  r2.xyzw = _FloatMask.Sample(sampler_FloatMask, r1.zw).xyzw;
  r1.z = dot(r2.xyz, float3(0.300000012,0.589999974,0.109999999));
  r1.z = r1.z * dc_f_cb0[8].y + dc_f_cb0[8].x;
  r1.w = r1.z + r1.y;
  r1.y = -dc_f_cb0[9].y + r1.y;
  r1.xy = r1.zz + r1.xy;
  r2.xy = v1.xy * dc_f_cb0[2].xy + dc_f_cb0[2].zw;
  r2.xyzw = _OpacityNoise.Sample(sampler_OpacityNoise, r2.xy).xyzw;
  r1.z = r2.x * dc_f_cb0[6].z + dc_f_cb0[6].w;
  ...
  r1.x = r1.z + -r1.y;
  r1.x = max(0, r1.x);
  r1.x = dc_f_cb0[11].w * r1.x;
  r1.xyz = dc_f_cb0[10].xyz * r1.xxx;
  r1.xyz = dc_f_cb0[13].xyz * r0.www + r1.xyz;
