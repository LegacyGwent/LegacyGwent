Shader "DynamicCards/Native/VFX_Special_Unicorn_flames" {
Properties {
_textures("_textures",2D)="white" {}
_noise("_noise",2D)="white" {}
_brightness("_brightness",Float)=5.0
...
dc_f_cb0[4]=float4(_brightness,_power,_speed,0);
  ...
  r0.x = v1.x + v1.x;
  r0.x = dc_f_cb1[0].y * dc_f_cb0[4].z + r0.x;
  r0.y = v1.y;
