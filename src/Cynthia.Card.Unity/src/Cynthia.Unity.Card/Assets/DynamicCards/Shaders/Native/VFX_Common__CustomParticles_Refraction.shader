Shader "DynamicCards/Native/VFX_Common__CustomParticles_Refraction" {
Properties {
...
dc_f_cb0[3]=float4(_Refractionamount,0,0,0);
  ...
  r0.xyzw = _node_2733.Sample(sampler_node_2733, r0.xy).xyzw;
  r0.x = r0.x * r0.w;
  r0.xy = r0.xy * float2(2,2) + float2(-1,-1);
  r0.xy = v2.ww * r0.xy;
  r0.zw = v3.xy / v3.ww;
  r0.xy = r0.xy * dc_f_cb0[3].xx + r0.zw;
