Shader "DynamicCards/Native/VFX_Common_Additive_moveInDirection_VertexColor" {
Properties {
...
dc_f_cb0[5]=float4(_Alphamultiplier,_Alphaexponent,_MaskUadd,_Usemask);
dc_f_cb0[6]=float4(_MaskUV,_Reversemaskdirection,_UseVertexColor,0);
  ...
  r0.x = saturate(dc_f_cb0[5].x * r0.x);
  r0.x = log2(r0.x);
  r0.x = dc_f_cb0[5].y * r0.x;
  r0.x = exp2(r0.x);
  r0.xyz = r0.yzw * r0.xxx;
  r0.w = v1.y + -v1.x;
  r0.w = dc_f_cb0[6].x * r0.w + v1.x;
  r1.x = 1 + -r0.w;
  r1.x = r1.x + -r0.w;
  r0.w = dc_f_cb0[6].y * r1.x + r0.w;
  r0.w = saturate(dc_f_cb0[5].z + r0.w);
  r0.w = -1 + r0.w;
  r0.w = dc_f_cb0[5].w * r0.w + 1;
  r0.xyz = r0.xyz * r0.www;
  r1.xyz = v4.xyz * v4.www + float3(-1,-1,-1);
  r1.xyz = dc_f_cb0[6].zzz * r1.xyz + float3(1,1,1);
