Shader "DynamicCards/Native/VFX_Special_MatCap_Metalic" {
Properties {
...
_SaturationLevel("_SaturationLevel",Float)=1.0
_MetalicLighting("_MetalicLighting",Float)=0.0
...
dc_f_cb0[9]=float4(_SaturationLevel,_MetalicLighting,0,0);
  ...
  r2.xyz = dc_f_cb0[4].xxx * r2.xyz;
  r1.xyz = r1.xyz * dc_f_cb0[7].yyy + r2.xyz;
  r1.yw = dc_f_cb2[10].xy * r1.yy;
  r1.xy = dc_f_cb2[9].xy * r1.xx + r1.yw;
  r1.xy = dc_f_cb2[11].xy * r1.zz + r1.xy;
