Shader "DynamicCards/Native/VFX_Effects_ImageLayerShaderFakeLight" {
Properties {
...
dc_f_cb0[5]=float4(_LightMask_ST.x,_LightMask_ST.y,_LightMask_ST.z,_LightMask_ST.w);
dc_f_cb0[6]=float4(_TintColor.x,_TintColor.y,_TintColor.z,_TintColor.w);
dc_f_cb0[7]=float4(_LightIntensity,0,0,0);
dc_f_cb0[8]=float4(__Turbulence_ST.x,__Turbulence_ST.y,__Turbulence_ST.z,__Turbulence_ST.w);
dc_f_cb0[9]=float4(_Speed,0,0,0);
dc_f_cb0[10]=float4(_TintMainTex.x,_TintMainTex.y,_TintMainTex.z,_TintMainTex.w);
  ...
  r1.x = 0.5 + dc_f_cb0[9].x;
  r0.w = r1.x * r0.w;
  r1.xy = r0.ww * dc_f_cb0[8].xy + dc_f_cb0[8].zw;
  ...
  r1.yzw = dc_f_cb0[10].xyz * r2.xyz;
  o0.w = r2.w;
  r1.yzw = r1.yzw + r1.yzw;
  o0.xyz = r0.xyz * r1.xxx + r1.yzw;
  return;
}
ENDCG
}
