Shader "DynamicCards/Native/VFX_Common_AlphaBlended_moveInDirection_VertexColor" {
Properties {
...
_UseVertexAlpha("_UseVertexAlpha",Float)=1.0
_UseVertexColor("_UseVertexColor",Float)=1.0
_MaskAdd("_MaskAdd",Float)=1.0
_MaskUV("_MaskUV",Float)=0.0
_Reversemask("_Reversemask",Float)=0.0
...
dc_f_cb0[6]=float4(_UseVertexColor,_UseVertexAlpha,_MaskAdd,_MaskUV);
dc_f_cb0[7]=float4(_Reversemask,0,0,0);
  ...
  r1.x = 1 / r1.x;
  r1.x = -1 + r1.x;
  r1.x = dc_f_cb0[5].y * r1.x + 1;
  r0.x = saturate(r1.x * r0.x);
  r1.x = -dc_f_cb0[5].w + r0.x;
  r1.x = ceil(r1.x);
  r1.x = r1.x + -r0.x;
  r0.x = dc_f_cb0[5].z * r1.x + r0.x;
  r1.xyzw = float4(-1,-1,-1,-1) + v4.xyzw;
  r1.xyzw = dc_f_cb0[6].xxxy * r1.xyzw + float4(1,1,1,1);
  r0.x = r1.w * r0.x;
  o0.xyz = r1.xyz * r0.yzw;
  r0.y = v1.y + -v1.x;
  r0.y = dc_f_cb0[6].w * r0.y + v1.x;
  r0.z = r0.y * -2 + 1;
  r0.y = dc_f_cb0[7].x * r0.z + r0.y;
  r0.y = dc_f_cb0[6].z + r0.y;
  r0.z = 2.5 + -r0.y;
