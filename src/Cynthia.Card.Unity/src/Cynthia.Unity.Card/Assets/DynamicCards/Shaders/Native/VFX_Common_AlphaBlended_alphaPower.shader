Shader "DynamicCards/Native/VFX_Common_AlphaBlended_alphaPower" {
Properties {
...
dc_f_cb0[4]=float4(_AlphaMultiplier,_AlphaExponent,_MIP,0);
  ...
  r0.xyzw = _MainTex.SampleLevel(sampler_MainTex, r0.xy, dc_f_cb0[4].z).xyzw;
  ...
  r0.x = exp2(r0.x);
  o0.w = saturate(dc_f_cb0[4].x * r0.x);
  return;
}
ENDCG
}
