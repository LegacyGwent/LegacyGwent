Shader "DynamicCards/Native/Custom_Particle_AdditiveAlphaScreenspaceMasked" {
Properties {
_MainTex("_MainTex",2D)="white" {}
_TintColor("_TintColor",Color)=(0.5,0.5,0.5,1.0)
_Multi("_Multi",Float)=6.0
_SemiAlphaForMeshParticles("_SemiAlphaForMeshParticles",Float)=1.0
...
float _Multi;
float _SemiAlphaForMeshParticles;
...
dc_f_cb0[4]=float4(_Multi,_SemiAlphaForMeshParticles,0,0);
dc_f_cb0[5]=float4(_AlphaGradient_ST.x,_AlphaGradient_ST.y,_AlphaGradient_ST.z,_AlphaGradient_ST.w);
