Shader "DynamicCards/Native/VFX_VertexAnimation_VertexAnimationManualTime" {
Properties {
_MainTex("_MainTex",2D)="white" {}
_VertexAnimation("_VertexAnimation",2D)="white" {}
_AnimationTime("_AnimationTime",Float)=1.0
...
dc_v_cb0[3]=float4(_AnimationTime,0,0,0);
...
dc_f_cb0[3]=float4(0,_CutOff,0,0);
