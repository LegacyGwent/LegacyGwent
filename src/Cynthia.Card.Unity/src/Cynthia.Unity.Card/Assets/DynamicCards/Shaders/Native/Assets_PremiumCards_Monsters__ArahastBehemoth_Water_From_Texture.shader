Shader "DynamicCards/Native/Assets_PremiumCards_Monsters__ArahastBehemoth_Water_From_Texture" {
Properties {
...
dc_v_cb0[5]=float4(_ProjectionParams.x,_ProjectionParams.y,_ProjectionParams.z,_ProjectionParams.w);
  ...
  o3.xyz = r2.xyz;
  r3.xyz = dc_v_cb1[1].xyz * v2.yyy;
  r3.xyz = dc_v_cb1[0].xyz * v2.xxx + r3.xyz;
  r3.xyz = dc_v_cb1[2].xyz * v2.zzz + r3.xyz;
...
dc_f_cb0[7]=float4(_Refraction_STR,_Displace_UV_Scale,0,0);
  ...
  r1.w = rsqrt(r1.w);
  r1.xyz = r1.xyz * r1.www;
  r1.w = dot(dc_f_cb1[0].xyz, dc_f_cb1[0].xyz);
  r1.w = rsqrt(r1.w);
  r3.xyz = dc_f_cb1[0].xyz * r1.www;
  r1.x = dot(r1.xyz, r3.xyz);
  r1.x = max(0, r1.x);
  r1.yzw = dc_f_cb2[0].xyz + dc_f_cb2[0].xyz;
