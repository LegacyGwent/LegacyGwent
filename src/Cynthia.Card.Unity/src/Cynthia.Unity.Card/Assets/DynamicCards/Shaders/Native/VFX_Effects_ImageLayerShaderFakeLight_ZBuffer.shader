Shader "DynamicCards/Native/VFX_Effects_ImageLayerShaderFakeLight_ZBuffer" {
Properties {
...
dc_f_cb0[4]=float4(_LightMask_ST.x,_LightMask_ST.y,_LightMask_ST.z,_LightMask_ST.w);
...
dc_f_cb0[7]=float4(_TintMainTex.x,_TintMainTex.y,_TintMainTex.z,_TintMainTex.w);
dc_f_cb0[8]=float4(_TintColor.x,_TintColor.y,_TintColor.z,_TintColor.w);
  ...
  r1.x = cmp(dc_f_cb0[6].w >= r0.w);
  if (r1.x != 0) discard;
  r0.xyzw = dc_f_cb0[7].xyzw * r0.xyzw;
  r0.xyzw = r0.xyzw + r0.xyzw;
  r1.xy = v1.xy * dc_f_cb0[3].xy + dc_f_cb0[3].zw;
  r1.xyzw = _Light.Sample(sampler_Light, r1.xy).xyzw;
  r2.xy = v1.xy * dc_f_cb0[4].xy + dc_f_cb0[4].zw;
  r2.xyzw = _LightMask.Sample(sampler_LightMask, r2.xy).xyzw;
  r1.xyz = r2.xyz * r1.xyz;
  r1.w = 0.5 + dc_f_cb0[6].y;
  r2.x = dc_f_cb1[0].x + dc_f_cb0[6].z;
  r1.w = r2.x * r1.w;
  r2.xy = r1.ww * dc_f_cb0[5].xy + dc_f_cb0[5].zw;
  r2.xyzw = _Turbulence.Sample(sampler_Turbulence, r2.xy).xyzw;
