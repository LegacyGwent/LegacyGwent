Shader "DynamicCards/Legacy/VFX_Common_Additive_moveInDirection_VertexColor_UVNoise" {
Properties {
...
_AlphaOverride("_AlphaOverride",Float)=1.0
}
SubShader {
...
dc_f_cb0[7]=float4(_AlphaOverride,0,0,0);
