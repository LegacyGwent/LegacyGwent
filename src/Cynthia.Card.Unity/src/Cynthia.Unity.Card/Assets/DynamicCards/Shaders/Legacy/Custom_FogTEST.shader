Shader "DynamicCards/Legacy/Custom_FogTEST" {
Properties {
_MainTex("_MainTex",2D)="white" {}
_TintColor("_TintColor",Color)=(0.5,0.5,0.5,1.0)
_maxParticleAlpha("_maxParticleAlpha",Float)=1.0
_OpacityTex("_OpacityTex",2D)="white" {}
_TimeMULT("_TimeMULT",Float)=1.5
_OpacityMULT("_OpacityMULT",Float)=2.0
_OpacitySIZE("_OpacitySIZE",Float)=0.30000001192092896
...
SamplerState sampler_OpacityTex;
Texture2D<float4> _MainTex;
Texture2D<float4> _OpacityTex;
float _OpacityMULT;
float _OpacitySIZE;
float _TimeMULT;
float _maxParticleAlpha;
float4 _MainTex_ST;
...
dc_f_cb0[5]=float4(_maxParticleAlpha,0,0,0);
dc_f_cb0[6]=float4(_OpacityTex_ST.x,_OpacityTex_ST.y,_OpacityTex_ST.z,_OpacityTex_ST.w);
dc_f_cb0[7]=float4(_TimeMULT,_OpacityMULT,_OpacitySIZE,0);
