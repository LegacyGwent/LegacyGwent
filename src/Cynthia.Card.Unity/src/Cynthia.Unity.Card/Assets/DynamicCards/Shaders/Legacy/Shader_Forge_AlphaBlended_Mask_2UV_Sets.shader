Shader "DynamicCards/Legacy/Shader_Forge_AlphaBlended_Mask_2UV_Sets" {
Properties {
_MainTex("_MainTex",2D)="white" {}
_TintColor("_TintColor",Color)=(0.5,0.5,0.5,1.0)
_TextureMask("_TextureMask",2D)="bump" {}
}
SubShader {
...
dc_f_cb0[4]=float4(_TextureMask_ST.x,_TextureMask_ST.y,_TextureMask_ST.z,_TextureMask_ST.w);
...
float4 dc_pack_ISGN_1=float4(v1.x,v1.y,w1.x,w1.y);
  ...
  r1.xy = dc_pack_ISGN_1.zw * dc_f_cb0[4].xy + dc_f_cb0[4].zw;
  r1.xyzw = _TextureMask.Sample(sampler_TextureMask, r1.xy).xyzw;
