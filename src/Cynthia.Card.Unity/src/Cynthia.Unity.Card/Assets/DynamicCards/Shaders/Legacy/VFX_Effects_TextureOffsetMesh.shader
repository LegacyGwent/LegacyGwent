...
dc_f_cb0[4]=float4(_TimeMULT,0,0,0);
dc_f_cb0[5]=float4(_AlphaMask_ST.x,_AlphaMask_ST.y,_AlphaMask_ST.z,_AlphaMask_ST.w);
dc_f_cb0[6]=float4(_MainTex_ST.x,_MainTex_ST.y,_MainTex_ST.z,_MainTex_ST.w);
dc_f_cb0[7]=float4(_TimeMULT2,0,0,0);
  ...
  r0.yz = float2(0.800000012,1.39999998) * v1.xy;
  r1.xy = r0.xx * dc_f_cb0[4].xx + r0.yz;
  r0.xy = r0.xx * dc_f_cb0[7].xx + r0.yz;
  ...
  r1.xyzw = _AlphaMask.Sample(sampler_AlphaMask, r1.xy).xyzw;
  r0.w = v2.w * r1.w;
