Shader "DynamicCards/Legacy/Custom_Particle_AlphaBlendedCC_AnimtedTexture" {
Properties {
...
dc_f_cb0[5]=float4(_numberofframes,_TurnOnRandomFrameOffsetStartColorblack0red1,_HSV_Saturation,_RED);
dc_f_cb0[6]=float4(_GREEN,_BLUE,_TurnonAnimationTexture,_HSV_Value);
  ...
  r1.x = r1.x / r1.y;
  r1.x = dc_f_cb0[5].z * r1.x;
  r0.yzw = r1.xxx * r0.yzw + float3(1,1,1);
  r0.xyz = r0.yzw * r0.xxx;
  o0.xyz = dc_f_cb0[3].xyz * r0.xyz;
  return;
}
ENDCG
}
