Shader "DynamicCards/Legacy/Shader_Forge_SnowLensShader" {
Properties {
_RefractionTex("_RefractionTex",2D)="black" {}
_Refraction("_Refraction",Float)=0.0
_MainTex("_MainTex",2D)="white" {}
_RefractionBlend("_RefractionBlend",Float)=0.30000001192092896
_Tint("_Tint",Color)=(0.6470587849617004,0.6470587849617004,0.6470587849617004,1.0)
_OpacityMULT("_OpacityMULT",Float)=1.600000023841858
...
dc_f_cb0[3]=float4(_RefractionTex_ST.x,_RefractionTex_ST.y,_RefractionTex_ST.z,_RefractionTex_ST.w);
dc_f_cb0[4]=float4(_Refraction,_RefractionBlend,0,0);
dc_f_cb0[5]=float4(_Tint.x,_Tint.y,_Tint.z,_Tint.w);
dc_f_cb0[6]=float4(_OpacityMULT,0,0,0);
  ...
  r0.x = -dc_f_cb1[5].x * dc_f_cb1[5].x;
  r1.xy = v2.xy / v2.ww;
  r1.z = r1.y * r0.x;
  r0.xy = r1.xz * float2(0.5,0.5) + float2(0.5,0.5);
  r0.zw = v1.xy * dc_f_cb0[3].xy + dc_f_cb0[3].zw;
  r1.xyzw = _RefractionTex.Sample(sampler_RefractionTex, r0.zw).xyzw;
  r0.zw = r1.xy * float2(2,2) + float2(-1,-1);
  r0.xy = r0.zw * dc_f_cb0[4].xx + r0.xy;
  ...
  r0.w = 1.20000005 * r1.y;
  r0.xyz = r0.xyz * r1.xxx + -r0.www;
  r1.x = v3.w * r1.w;
  o0.w = dc_f_cb0[6].x * r1.x;
  r0.xyz = dc_f_cb0[4].yyy * r0.xyz + r0.www;
