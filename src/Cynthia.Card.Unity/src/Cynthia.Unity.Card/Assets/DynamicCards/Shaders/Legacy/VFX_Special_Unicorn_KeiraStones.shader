Shader "DynamicCards/Legacy/VFX_Special_Unicorn_KeiraStones" {
Properties {
...
_Y("_Y",Float)=-0.5
_Z("_Z",Float)=1.0
_LightBeamWidth("_LightBeamWidth",Float)=1.0
_LightColour("_LightColour",Color)=(1.0,1.0,1.0,1.0)
_node_8244("_node_8244",Float)=1.0
...
dc_f_cb0[6]=float4(_Y,_Z,_LightBeamWidth,0);
dc_f_cb0[7]=float4(_LightColour.x,_LightColour.y,_LightColour.z,_LightColour.w);
dc_f_cb0[8]=float4(_node_8244,0,0,0);
  ...
  r1.x = saturate(r0.w * 0.5 + 0.5);
  r1.x = log2(r1.x);
  r1.x = dc_f_cb0[6].z * r1.x;
  r1.x = exp2(r1.x);
  r1.yzw = dc_f_cb0[7].xyz * dc_f_cb0[5].xxx + -dc_f_cb0[5].yyy;
  r1.xyz = r1.xxx * r1.yzw + dc_f_cb0[5].yyy;
  r1.w = dc_f_cb0[5].x + -dc_f_cb0[5].y;
  r0.w = r0.w * r1.w + dc_f_cb0[5].y;
  r1.xyz = r1.xyz + -r0.www;
  r1.xyz = saturate(dc_f_cb0[8].xxx * r1.xyz + r0.www);
