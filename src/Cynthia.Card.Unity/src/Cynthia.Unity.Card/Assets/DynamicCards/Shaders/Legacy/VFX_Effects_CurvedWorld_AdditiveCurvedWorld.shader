Shader "DynamicCards/Legacy/VFX_Effects_CurvedWorld_AdditiveCurvedWorld" {
Properties {
...
dc_v_cb0[3]=float4(_Curvature,_Curvature2,0,0);
dc_v_cb0[4]=float4(_CamPosition.x,_CamPosition.y,_CamPosition.z,_CamPosition.w);
  ...
  r0.xy = -dc_v_cb0[4].zx + r0.xy;
  r0.xy = r0.xy * r0.xy;
  r0.y = r0.x + r0.y;
  r1.xy = -dc_v_cb0[3].yx * r0.xy;
  r1.z = 0;
