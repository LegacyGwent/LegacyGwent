Shader "DynamicCards/Legacy/Custom_ApearShader" {
Properties {
...
dc_f_cb0[4]=float4(_Strenght,_Border,_NoiseStr,_TimeMulti);
dc_f_cb0[5]=float4(_Noise_ST.x,_Noise_ST.y,_Noise_ST.z,_Noise_ST.w);
dc_f_cb0[6]=float4(_Reflection,0,0,0);
dc_f_cb0[7]=float4(_TintCol.x,_TintCol.y,_TintCol.z,_TintCol.w);
dc_f_cb0[8]=float4(_Strenght_Burn,_BurnValue,_OpacityBlur,_FrenselValue);
dc_f_cb0[9]=float4(_opacityColor.x,_opacityColor.y,_opacityColor.z,_opacityColor.w);
dc_f_cb0[10]=float4(_NoiseSmall_ST.x,_NoiseSmall_ST.y,_NoiseSmall_ST.z,_NoiseSmall_ST.w);
dc_f_cb0[11]=float4(_Mask_ST.x,_Mask_ST.y,_Mask_ST.z,_Mask_ST.w);
dc_f_cb0[12]=float4(_MaskVertical,_MaskBlur,_somfReflect,_Opacity2);
dc_f_cb0[13]=float4(_FresnelColor.x,_FresnelColor.y,_FresnelColor.z,_FresnelColor.w);
dc_f_cb0[14]=float4(_MaskStrenght,0,0,0);
  ...
  r0.x = 1 + -r0.x;
  r0.x = log2(r0.x);
  r0.x = dc_f_cb0[8].w * r0.x;
  r0.x = exp2(r0.x);
  r0.x = r0.x + r0.x;
  r0.y = r0.x * r0.x;
  r0.zw = v1.xy * dc_f_cb0[10].xy + dc_f_cb0[10].zw;
  r1.xyzw = _NoiseSmall.Sample(sampler_NoiseSmall, r0.zw).xyzw;
  r0.zw = v1.xy * dc_f_cb0[5].xy + dc_f_cb0[5].zw;
  r2.xyzw = _Noise.Sample(sampler_Noise, r0.zw).xyzw;
  r0.z = -r2.y + r1.y;
  r0.w = dc_f_cb0[12].x + v1.y;
  r0.w = saturate(dc_f_cb0[12].y * r0.w);
  r0.z = r0.w * r0.z + r2.y;
  r1.x = dc_f_cb1[0].y + dc_f_cb0[2].y;
  r1.xy = r1.xx * dc_f_cb0[4].ww + v1.xy;
  r1.zw = r1.xy * dc_f_cb0[10].xy + dc_f_cb0[10].zw;
  r2.xyzw = _NoiseSmall.Sample(sampler_NoiseSmall, r1.zw).xyzw;
  r1.zw = r1.xy * dc_f_cb0[5].xy + dc_f_cb0[5].zw;
  r1.xy = dc_f_cb0[12].zz * r1.xy;
  r1.xy = r1.xy * dc_f_cb0[10].xy + dc_f_cb0[10].zw;
  r3.xyzw = _NoiseSmall.Sample(sampler_NoiseSmall, r1.xy).xyzw;
  r1.xy = dc_f_cb0[6].xx * r3.xy;
  r3.xyzw = _Noise.Sample(sampler_Noise, r1.zw).xyzw;
  r1.zw = -r3.xy + r2.xy;
  r1.zw = r0.ww * r1.zw + r3.xy;
  r0.w = saturate(dc_f_cb0[12].w + r0.w);
  r0.z = r1.z * r0.z;
  r1.zw = r1.zw * dc_f_cb0[4].zz + v1.xy;
  r1.zw = r1.zw * dc_f_cb0[3].xy + dc_f_cb0[3].zw;
  r2.xyzw = _MainTex.Sample(sampler_MainTex, r1.zw).xyzw;
  r1.zw = v1.xy * dc_f_cb0[11].xy + dc_f_cb0[11].zw;
  r3.xyzw = _Mask.Sample(sampler_Mask, r1.zw).xyzw;
  r1.z = saturate(dc_f_cb0[14].x + r3.x);
  r1.w = dc_f_cb0[4].x * r1.z;
  r1.z = dc_f_cb0[8].x * r1.z;
  r1.z = r1.z * r0.z;
  r0.z = r1.w * r0.z;
  r0.z = log2(r0.z);
  r0.z = dc_f_cb0[8].z * r0.z;
  r0.z = exp2(r0.z);
  r0.z = min(1, r0.z);
  r0.z = 1 + -r0.z;
  r1.z = log2(r1.z);
  r1.z = dc_f_cb0[4].y * r1.z;
  r1.z = exp2(r1.z);
  r1.z = min(1, r1.z);
  r3.xyz = -r1.zzz * dc_f_cb0[7].xyz + float3(1,1,1);
  r3.xyz = dc_f_cb0[8].yyy * r3.xyz;
  r2.xyz = r2.xyz / r3.xyz;
  r0.x = r0.y * r0.x + r0.z;
  r3.xyz = dc_f_cb0[13].xyz + -dc_f_cb0[9].xyz;
  r3.xyz = r0.xxx * r3.xyz + dc_f_cb0[9].xyz;
  r0.x = saturate(dc_f_cb0[9].w * r0.w + r0.x);
  r0.x = r2.w * r0.x;
