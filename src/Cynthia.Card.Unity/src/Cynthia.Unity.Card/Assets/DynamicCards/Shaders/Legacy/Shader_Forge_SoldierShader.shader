Shader "DynamicCards/Legacy/Shader_Forge_SoldierShader" {
Properties {
_MainTex("_MainTex",2D)="white" {}
_TintColor("_TintColor",Color)=(0.5,0.5,0.5,1.0)
_TimeMULT("_TimeMULT",Float)=0.5
_VertexOffset("_VertexOffset",2D)="white" {}
_OffestMULT("_OffestMULT",Float)=0.0
...
SamplerState sampler_VertexOffset;
Texture2D<float4> _MainTex;
Texture2D<float4> _VertexOffset;
float _OffestMULT;
float _TimeMULT;
float4 _MainTex_ST;
float4 _TimeEditor;
float4 _TintColor;
float4 _VertexOffset_ST;
...
dc_v_cb0[5]=float4(_TimeMULT,0,0,0);
dc_v_cb0[6]=float4(_VertexOffset_ST.x,_VertexOffset_ST.y,_VertexOffset_ST.z,_VertexOffset_ST.w);
dc_v_cb0[7]=float4(_OffestMULT,0,0,0);
  ...
  r0.xy = r0.xx * dc_v_cb0[5].xx + v1.xy;
  r0.xy = r0.xy * dc_v_cb0[6].xy + dc_v_cb0[6].zw;
  r0.xyzw = _VertexOffset.SampleLevel(sampler_VertexOffset, r0.xy, 0).xyzw;
  r0.xyz = r0.xyz * dc_v_cb0[7].xxx + v0.xyz;
