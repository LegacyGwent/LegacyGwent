Shader "DynamicCards/Legacy/VFX_Special_Unicorn_the_last_wish_trail_small" {
Properties {
_noise_vertex("_noise_vertex",2D)="white" {}
_node_1829("_node_1829",Color)=(0.5,0.5,0.5,1.0)
...
dc_f_cb0[3]=float4(_noise_vertex_ST.x,_noise_vertex_ST.y,_noise_vertex_ST.z,_noise_vertex_ST.w);
dc_f_cb0[4]=float4(_node_1829.x,_node_1829.y,_node_1829.z,_node_1829.w);
dc_f_cb0[5]=float4(_colour_multiply,_speed,0,0);
  ...
  r0.y = r0.x * dc_f_cb0[5].y + v1.y;
  r0.x = v1.x;
  r0.xy = r0.xy * dc_f_cb0[3].xy + dc_f_cb0[3].zw;
  r0.xyzw = _noise_vertex.Sample(sampler_noise_vertex, r0.xy).xyzw;
  r0.xyz = log2(r0.xyz);
