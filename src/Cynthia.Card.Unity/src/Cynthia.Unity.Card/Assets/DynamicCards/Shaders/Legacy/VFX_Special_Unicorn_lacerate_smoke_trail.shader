Shader "DynamicCards/Legacy/VFX_Special_Unicorn_lacerate_smoke_trail" {
Properties {
...
dc_v_cb0[6]=float4(_Frequency,_Speed,_OffsetStrenght,_Switch);
  ...
  r0.xyz = r0.xyz / dc_v_cb0[6].xxx;
  r0.w = dc_v_cb1[0].y + dc_v_cb0[2].y;
  r0.xyz = r0.www * dc_v_cb0[6].yyy + r0.xyz;
  r0.xyz = sin(r0.xyz);
  r0.xyz = dc_v_cb0[6].zzz * r0.xyz;
  r0.xyz = r0.xyz * v2.xyz + float3(-1,-1,-1);
  r0.xyz = dc_v_cb0[6].www * r0.xyz + v0.xyz;
...
dc_f_cb0[3]=float4(_node_8719_ST.x,_node_8719_ST.y,_node_8719_ST.z,_node_8719_ST.w);
dc_f_cb0[4]=float4(_node_4056.x,_node_4056.y,_node_4056.z,_node_4056.w);
dc_f_cb0[5]=float4(_cloud_speed,_speed_2,_alpcha,_mask_multiply);
