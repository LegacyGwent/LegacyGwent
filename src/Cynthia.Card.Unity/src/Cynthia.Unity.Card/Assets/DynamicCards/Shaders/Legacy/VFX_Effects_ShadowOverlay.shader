Shader "DynamicCards/Legacy/VFX_Effects_ShadowOverlay" {
Properties {
...
dc_f_cb0[3]=float4(_OverlayTex_ST.x,_OverlayTex_ST.y,_OverlayTex_ST.z,_OverlayTex_ST.w);
dc_f_cb0[4]=float4(_CutOffThreshold,0,0,0);
...
float4 dc_pack_ISGN_1=float4(v1.x,v1.y,w1.x,w1.y);
  ...
  if (r1.x != 0) discard;
  r1.xy = dc_pack_ISGN_1.zw * dc_f_cb0[3].xy + dc_f_cb0[3].zw;
  r1.xyzw = _OverlayTex.Sample(sampler_OverlayTex, r1.xy).xyzw;
