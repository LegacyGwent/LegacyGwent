Shader "DynamicCards/Legacy/VFX_Effects_ImageLayerShaderSpecular" {
Properties {
...
dc_f_cb0[7]=float4(_Speed,_TimeOffset,0,0);
dc_f_cb0[8]=float4(_LightTint.x,_LightTint.y,_LightTint.z,_LightTint.w);
dc_f_cb0[9]=float4(_SpecSharpness,_SpecSize,_off_RG_on,_on_B);
dc_f_cb0[10]=float4(_Move,_Displaceamount,_SpecRange,0);
  ...
  r0.w = r1.y + -r1.x;
  r0.w = dc_f_cb0[9].z * r0.w + r1.x;
  r1.x = r1.z + -r0.w;
  r0.w = dc_f_cb0[9].w * r1.x + r0.w;
  r0.w = dc_f_cb0[10].x + r0.w;
  r0.w = dc_f_cb0[10].z * dc_f_cb0[10].y + r0.w;
  r1.x = -dc_f_cb0[9].x * r0.w + 1;
  r0.w = dc_f_cb0[9].x * r0.w + dc_f_cb0[9].y;
  r1.x = dc_f_cb0[9].y + r1.x;
  r0.w = saturate(r1.x * r0.w);
  r1.x = dc_f_cb1[0].x + dc_f_cb0[2].x;
  r1.x = dc_f_cb0[7].y + r1.x;
  r1.y = 0.5 + dc_f_cb0[7].x;
  r1.x = r1.y * r1.x;
  r1.xy = r1.xx * dc_f_cb0[6].xy + dc_f_cb0[6].zw;
  r1.xyzw = __Turbulence.Sample(sampler__Turbulence, r1.xy).xyzw;
  r1.yz = v1.xy * dc_f_cb0[4].xy + dc_f_cb0[4].zw;
  r2.xyzw = _Light.Sample(sampler_Light, r1.yz).xyzw;
  r1.yzw = dc_f_cb0[8].xyz * r2.xyz;
  r1.yzw = dc_f_cb0[5].xxx * r1.yzw;
