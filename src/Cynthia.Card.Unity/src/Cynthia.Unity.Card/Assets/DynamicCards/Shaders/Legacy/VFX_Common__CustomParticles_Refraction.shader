Shader "DynamicCards/Legacy/VFX_Common__CustomParticles_Refraction" {
Properties {
_node_2733("_node_2733",2D)="bump" {}
_Refractionamount("_Refractionamount",Float)=1.0
...
SamplerState sampler_node_2733;
Texture2D<float4> _GrabTexture;
Texture2D<float4> _node_2733;
float _Refractionamount;
float4 _node_2733_ST;
...
dc_f_cb0[2]=float4(_node_2733_ST.x,_node_2733_ST.y,_node_2733_ST.z,_node_2733_ST.w);
dc_f_cb0[3]=float4(_Refractionamount,0,0,0);
  ...
  r1.xyzw = _node_2733.Sample(sampler_node_2733, r0.zw).xyzw;
  r0.zw = r1.wy * float2(2,2) + float2(-1,-1);
  r0.zw = v3.ww * r0.zw;
  r0.xy = r0.zw * dc_f_cb0[3].xx + r0.xy;
