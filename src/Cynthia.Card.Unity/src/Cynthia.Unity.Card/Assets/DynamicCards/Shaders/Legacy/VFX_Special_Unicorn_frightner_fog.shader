Shader "DynamicCards/Legacy/VFX_Special_Unicorn_frightner_fog" {
Properties {
...
dc_f_cb0[10]=float4(_mask_top,_cloud_speed,_snow_power,_snowRotation);
  ...
  sincos(dc_f_cb0[10].w, r2.x, r3.x);
  r4.z = r2.x;
  r4.y = r3.x;
  r4.x = -r2.x;
  ...
  r2.xyz = dc_f_cb0[9].xyz + -r1.yyy;
  r1.yzw = dc_f_cb0[10].xxx * r2.xyz + r1.yyy;
