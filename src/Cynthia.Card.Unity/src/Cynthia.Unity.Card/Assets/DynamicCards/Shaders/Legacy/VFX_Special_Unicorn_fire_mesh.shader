Shader "DynamicCards/Legacy/VFX_Special_Unicorn_fire_mesh" {
Properties {
...
_node_3718("_node_3718",Color)=(0.5,0.5,0.5,1.0)
...
dc_f_cb0[11]=float4(_node_3718.x,_node_3718.y,_node_3718.z,_node_3718.w);
dc_f_cb0[12]=float4(_mipmaps,0,0,0);
  ...
  r0.xyzw = _node_5030.SampleLevel(sampler_node_5030, r0.xy, dc_f_cb0[12].x).xyzw;
  r0.xyz = log2(r0.xyz);
  ...
  r1.xyzw = _node_331.SampleLevel(sampler_node_331, r1.xy, dc_f_cb0[12].x).xyzw;
  r1.xyz = log2(r1.xyz);
  ...
  r1.xy = abs(v1.xy) * float2(1.33333302,6.66666698) + float2(-0.133333296,-1);
  r0.w = r1.y * r0.w;
  r0.xyz = r0.xyz * r0.www;
  r1.yzw = dc_f_cb0[9].xyz + -r1.xxx;
  r1.xyz = dc_f_cb0[10].xxx * r1.yzw + r1.xxx;
  r0.xyz = r1.xyz * r0.xyz;
  r1.xyz = float3(0.5,0.5,0.5) * r0.xyz;
  r2.xyz = r1.xyz * r1.xyz;
  r1.xyz = r2.xyz * r1.xyz;
  r0.xyz = r0.xyz * float3(0.5,0.5,0.5) + -r1.xyz;
  r0.xyz = abs(v1.xxx) * r0.xyz + r1.xyz;
