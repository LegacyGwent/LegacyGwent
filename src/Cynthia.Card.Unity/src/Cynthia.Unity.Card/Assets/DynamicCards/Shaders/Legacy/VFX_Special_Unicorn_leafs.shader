Shader "DynamicCards/Legacy/VFX_Special_Unicorn_leafs" {
Properties {
_node_6318("_node_6318",2D)="white" {}
_desaturate("_desaturate",Float)=0.0
_colour("_colour",Color)=(0.5,0.5,0.5,1.0)
_light_position("_light_position",Vector)=(0.5,-0.5,1.0,0.0)
...
dc_f_cb0[5]=float4(_light_position.x,_light_position.y,_light_position.z,_light_position.w);
dc_f_cb0[6]=float4(_light_intensuty,_ambient_light,_light_multi,0);
  ...
  r0.x = dot(r0.xyz, dc_f_cb0[5].xyz);
  r0.y = dc_f_cb0[6].x + -dc_f_cb0[6].y;
  r0.x = saturate(r0.x * r0.y + dc_f_cb0[6].y);
  r0.yz = v1.xy * dc_f_cb0[2].xy + dc_f_cb0[2].zw;
  r1.xyzw = _node_6318.Sample(sampler_node_6318, r0.yz).xyzw;
  r0.y = dot(r1.xyz, float3(0.300000012,0.589999974,0.109999999));
  r0.yzw = r0.yyy + -r1.xyz;
  r0.yzw = dc_f_cb0[3].xxx * r0.yzw + r1.xyz;
  o0.w = r1.w;
  r0.yzw = dc_f_cb0[4].xyz * r0.yzw;
