Shader "DynamicCards/Legacy/VFX_Special_Unicorn_unicorn_glow" {
Properties {
...
dc_f_cb0[6]=float4(_colour_multiply,_dot_multiply,0,0);
  ...
  r1.xyzw = r0.yyyy * float4(0.00999999978,0.5,0.100000001,0.400000006) + v1.xyxy;
  r0.yz = dc_f_cb0[4].xy * r1.xy;
  r1.xy = dc_f_cb0[5].xy * r1.zw;
  r1.xy = r1.xy * float2(1.5,1.5) + dc_f_cb0[5].zw;
  r1.xyzw = _node_8470.Sample(sampler_node_8470, r1.xy).xyzw;
  r1.xyz = log2(r1.xyz);
  r1.xyz = float3(1.29999995,1.29999995,1.29999995) * r1.xyz;
  r1.xyz = exp2(r1.xyz);
  r1.xyz = dc_f_cb0[6].yyy * r1.xyz;
  r0.yz = r0.yz * float2(2,0.5) + dc_f_cb0[4].zw;
  r2.xyzw = _node_7207.Sample(sampler_node_7207, r0.yz).xyzw;
  r0.xyz = r2.xyz * r0.xxx + r0.xxx;
  r0.xyz = log2(r0.xyz);
