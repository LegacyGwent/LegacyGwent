Shader "DynamicCards/Legacy/VFX_Effects_FlowingFlowmapOpacity" {
Properties {
...
dc_f_cb0[9]=float4(_ColorGain,_Premult,_AlphaGain,0);
  ...
  r1.xyzw = r1.wxyz + -r2.wxyz;
  r0.xyzw = abs(r0.zzzz) * r1.xyzw + r2.wxyz;
  r0.xyzw = dc_f_cb0[8].wxyz * r0.xyzw;
  r1.x = saturate(dc_f_cb0[9].z * r0.x);
  r1.x = -1 + r1.x;
  r1.x = dc_f_cb0[9].y * r1.x + 1;
  r0.yzw = r1.xxx * r0.yzw;
  o0.w = r0.x;
  o0.xyz = dc_f_cb0[9].xxx * r0.yzw;
  return;
}
ENDCG
}
