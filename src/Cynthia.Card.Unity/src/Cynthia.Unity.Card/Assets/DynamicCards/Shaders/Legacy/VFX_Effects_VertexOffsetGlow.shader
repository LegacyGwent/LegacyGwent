Shader "DynamicCards/Legacy/VFX_Effects_VertexOffsetGlow" {
Properties {
...
dc_f_cb0[6]=float4(_OffsetAmount,_Speed,0,0);
...
float4 dc_pack_ISGN_1=float4(v1.x,v1.y,w1.x,w1.y);
  ...
  r0.x = dc_f_cb1[0].y * dc_f_cb0[6].y + 0.5;
  r0.x = frac(r0.x);
  r0.yz = dc_pack_ISGN_1.xy * dc_f_cb0[5].xy + dc_f_cb0[5].zw;
  r1.xyzw = _FlowMap.Sample(sampler_FlowMap, r0.yz).xyzw;
  r0.yz = r1.xy * float2(2,2) + float2(-1,-1);
  r0.yz = dc_f_cb0[6].xx * r0.yz;
  r0.xw = r0.yz * r0.xx + dc_pack_ISGN_1.xy;
  r0.xw = r0.xw * dc_f_cb0[3].xy + dc_f_cb0[3].zw;
  r1.xyzw = _MainTex.Sample(sampler_MainTex, r0.xw).xyzw;
  r0.x = dc_f_cb1[0].y * dc_f_cb0[6].y;
  r0.x = frac(r0.x);
  r0.yz = r0.yz * r0.xx + dc_pack_ISGN_1.xy;
  r0.x = -0.5 + r0.x;
  r0.x = r0.x + r0.x;
  r0.yz = r0.yz * dc_f_cb0[3].xy + dc_f_cb0[3].zw;
  r2.xyzw = _MainTex.Sample(sampler_MainTex, r0.yz).xyzw;
  r1.xyzw = -r2.xyzw + r1.xyzw;
  o0.xyzw = abs(r0.xxxx) * r1.xyzw + r2.xyzw;
  return;
}
ENDCG
}
