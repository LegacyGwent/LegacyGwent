Shader "DynamicCards/Legacy/Custom_Particle_AdditiveAlphaMasked" {
Properties {
_MainTex("_MainTex",2D)="white" {}
_TintColor("_TintColor",Color)=(0.5,0.5,0.5,1.0)
_RGBMask("_RGBMask",2D)="white" {}
...
SamplerState sampler_RGBMask;
Texture2D<float4> _MainTex;
Texture2D<float4> _RGBMask;
float4 _MainTex_ST;
float4 _RGBMask_ST;
float4 _TintColor;
...
dc_f_cb0[4]=float4(_RGBMask_ST.x,_RGBMask_ST.y,_RGBMask_ST.z,_RGBMask_ST.w);
  ...
  r1.xyzw = _RGBMask.Sample(sampler_RGBMask, r1.xy).xyzw;
