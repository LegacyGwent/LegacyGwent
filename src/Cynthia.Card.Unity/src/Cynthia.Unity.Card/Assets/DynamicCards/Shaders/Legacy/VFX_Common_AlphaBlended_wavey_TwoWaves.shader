Shader "DynamicCards/Legacy/VFX_Common_AlphaBlended_wavey_TwoWaves" {
Properties {
...
_Wavelength2("_Wavelength2",Float)=1.0
_UseUorV2("_UseUorV2",Float)=0.0
_UVmidpoint2("_UVmidpoint2",Float)=0.0
_Timeoffset2("_Timeoffset2",Float)=0.0
_Offsetamount2("_Offsetamount2",Float)=0.10000000149011612
_Timemultiplier2("_Timemultiplier2",Float)=1.0
_VerticalHorizontal2("_VerticalHorizontal2",Float)=0.0
...
dc_v_cb0[6]=float4(0,_Usetextureoffset,0,0);
dc_v_cb0[7]=float4(_Offsettexture_ST.x,_Offsettexture_ST.y,_Offsettexture_ST.z,_Offsettexture_ST.w);
dc_v_cb0[8]=float4(_VerticalHorizontal,_VColourOn,_Texturetimeoffset,_Wavelength2);
dc_v_cb0[9]=float4(_UseUorV2,_UVmidpoint2,_Timeoffset2,_Offsetamount2);
dc_v_cb0[10]=float4(_Timemultiplier2,_VerticalHorizontal2,0,0);
  ...
  r0.x = v1.y + -v1.x;
  r0.y = dc_v_cb0[9].x * r0.x + v1.x;
  r0.x = dc_v_cb0[4].x * r0.x + v1.x;
  r0.x = -dc_v_cb0[5].x + r0.x;
  r0.y = -dc_v_cb0[9].y + r0.y;
  r0.y = dc_v_cb0[8].w * r0.y;
  r0.z = dc_v_cb1[0].y + dc_v_cb0[2].y;
  r0.y = r0.z * dc_v_cb0[10].x + r0.y;
  r0.z = dc_v_cb0[4].y * r0.z;
  r0.z = r0.x * dc_v_cb0[4].w + r0.z;
  r0.z = dc_v_cb0[5].w + r0.z;
  r0.z = v2.w * dc_v_cb0[8].z + r0.z;
  r0.z = sin(r0.z);
  r1.y = dc_v_cb0[4].z * r0.z;
  r0.y = dc_v_cb0[9].z + r0.y;
  r0.y = cos(r0.y);
  r1.w = r0.y * dc_v_cb0[9].w + r1.y;
  r1.xz = float2(0,0);
  r0.yzw = r1.wzz + -r1.zwz;
  r0.yzw = dc_v_cb0[10].yyy * r0.yzw + r1.zwz;
  r2.xyz = r1.yzz + -r1.xyx;
  r1.xyz = dc_v_cb0[8].xxx * r2.xyz + r1.zyz;
  ...
  r0.w = -1 + r1.z;
  r0.w = dc_v_cb0[6].y * r0.w + 1;
  r1.xyz = r0.xyz * r0.www;
  r0.xyz = r0.xyz * v2.zzz + -r1.xyz;
  r0.xyz = dc_v_cb0[8].yyy * r0.xyz + r1.xyz;
...
dc_f_cb0[6]=float4(_cutoff,0,0,0);
