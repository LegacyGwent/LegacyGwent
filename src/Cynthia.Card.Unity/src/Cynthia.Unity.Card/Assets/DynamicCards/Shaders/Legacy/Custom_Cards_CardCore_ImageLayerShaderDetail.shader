Shader "DynamicCards/Legacy/Custom_Cards_CardCore_ImageLayerShaderDetail" {
Properties {
_MainTex("_MainTex",2D)="white" {}
_Detail("_Detail",2D)="white" {}
...
dc_f_cb0[3]=float4(_Detail_ST.x,_Detail_ST.y,_Detail_ST.z,_Detail_ST.w);
  ...
  r0.xyzw = _Detail.Sample(sampler_Detail, r0.xy).xyzw;
