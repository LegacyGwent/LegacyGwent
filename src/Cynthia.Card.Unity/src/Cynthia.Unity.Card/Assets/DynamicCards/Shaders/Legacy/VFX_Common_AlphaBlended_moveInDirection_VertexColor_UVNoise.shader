Shader "DynamicCards/Legacy/VFX_Common_AlphaBlended_moveInDirection_VertexColor_UVNoise" {
Properties {
...
dc_f_cb0[7]=float4(_AlphaPower,_ColorGain,0,0);
  ...
  r0.zw = dc_f_cb1[0].yy * dc_f_cb0[4].xy + v1.xy;
  r0.xy = r0.xy * dc_f_cb0[6].zz + r0.zw;
