Shader "DynamicCards/Legacy/Custom_WallLight" {
Properties {
...
dc_f_cb0[4]=float4(_MaskTexture_ST.x,_MaskTexture_ST.y,_MaskTexture_ST.z,_MaskTexture_ST.w);
dc_f_cb0[5]=float4(_TimeMultiplier,_Colorsubstract,_ColorMultiplier,_MaskExponent);
dc_f_cb0[6]=float4(_MaskScale,_TimeOffset,0,0);
dc_f_cb0[7]=float4(_TintColor.x,_TintColor.y,_TintColor.z,_TintColor.w);
dc_f_cb0[8]=float4(_Miplevel,_TimeV,0,0);
  ...
  r1.x = dc_f_cb0[5].x * r0.x;
  r1.y = dc_f_cb0[8].y * r0.x;
  r0.xy = v1.xy * dc_f_cb0[6].xx + r1.xy;
  ...
  r1.xyzw = _MainTexture.SampleLevel(sampler_MainTexture, r1.xy, dc_f_cb0[8].x).xyzw;
  r1.xyz = saturate(-dc_f_cb0[5].yyy + r1.xyz);
  r0.xyz = r1.xyz * r0.xyz;
  r0.xyz = r0.xyz * r1.www;
  r0.xyz = dc_f_cb0[5].zzz * r0.xyz;
  o0.xyz = dc_f_cb0[7].xyz * r0.xyz;
  o0.w = 1;
  return;
}
ENDCG
