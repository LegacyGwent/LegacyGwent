Shader "DynamicCards/Legacy/VFX_PremiumCards_AlphaCutoff_wavey" {
Properties {
...
dc_v_cb0[6]=float4(_Offsettexturebluechannel_ST.x,_Offsettexturebluechannel_ST.y,_Offsettexturebluechannel_ST.z,_Offsettexturebluechannel_ST.w);
dc_v_cb0[7]=float4(_VerticalHorizontalmovement,0,0,0);
  ...
  r0.y = dc_v_cb0[4].y * r0.y;
  r0.x = r0.x * dc_v_cb0[4].w + r0.y;
  r0.x = dc_v_cb0[5].x + r0.x;
  r0.x = sin(r0.x);
  r0.y = dc_v_cb0[4].z * r0.x;
  r0.xz = float2(0,0);
  r1.xyz = r0.yzz + -r0.zyz;
  r0.xyz = dc_v_cb0[7].xxx * r1.xyz + r0.xyz;
...
dc_f_cb0[7]=float4(0,_AlphaCutoff,0,0);
