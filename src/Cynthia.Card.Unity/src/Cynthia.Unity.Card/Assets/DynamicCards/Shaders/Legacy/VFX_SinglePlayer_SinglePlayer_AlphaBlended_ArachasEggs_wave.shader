Shader "DynamicCards/Legacy/VFX_SinglePlayer_SinglePlayer_AlphaBlended_ArachasEggs_wave" {
Properties {
...
dc_v_cb0[8]=float4(_VerticalHorizontal,_VColourOn,_Texturetimeoffset,0);
  ...
  r0.x = v2.w * dc_v_cb0[8].z + r0.x;
  r0.x = sin(r0.x);
  r1.y = dc_v_cb0[4].z * r0.x;
  r1.xz = float2(0,0);
  r0.xzw = r1.yzz + -r1.zyz;
  r0.xzw = dc_v_cb0[8].xxx * r0.xzw + r1.xyz;
  r1.x = 1 / dc_v_cb0[5].y;
  r0.y = r1.x * r0.y;
  r0.y = min(1, abs(r0.y));
  r0.y = log2(r0.y);
