...
Identical faction copies share effect and behavior assertions while retaining their
own names and factions. Since September 16, Monsters Draug `22002` and Northern
Draug `70197` both select up to eight targets; art `13210100` and rules text remain shared. Great Griffin needs a headless
