...
Since CardMap `1.0.0.171`, Syanna no longer repeats Deploy. As of CardMap
`1.0.0.193`, she uses the normal `AfterTurnStart` event, decrements a visible
two-turn Countdown only at the start of her owner's turns, and then deals the
amount she is currently wounded
